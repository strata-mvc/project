...
class ITSEC_Strong_Passwords_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings['enabled'] === true && $this->settings['roll'] == 'subscriber' ) {
			...
			$status       = array(
				'text' => __( 'You are enforcing strong passwords for all users.', 'it-l10n-ithemes-security-pro' ),
			...
			$status_array = 'low';
			$status       = array(
				'text' => __( 'You are enforcing strong passwords, but not for all users.', 'it-l10n-ithemes-security-pro' ),
				'link' => '#itsec_strong_passwords_enabled',
			);
			...
			$status_array = 'high';
			$status       = array(
				'text' => __( 'You are not enforcing strong passwords for any users.', 'it-l10n-ithemes-security-pro' ),
				'link' => '#itsec_strong_passwords_enabled',
			);
