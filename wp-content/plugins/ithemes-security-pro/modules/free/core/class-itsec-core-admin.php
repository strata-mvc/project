...
class ITSEC_Core_Admin {
	...
	public function add_plugin_meta_links( $meta ) {
		...
		$meta[] = '<a href="http://ithemes.com/security/ithemes-security-professional-setup" target="_blank">' . __( 'Get Pro Setup', 'it-l10n-ithemes-security-pro' ) . '</a>';
		$meta[] = '<a href="http://ithemes.com/security" target="_blank">' . __( 'Get Support', 'it-l10n-ithemes-security-pro' ) . '</a>';
	...
	public function metabox_get_started() {
		...
		echo '<p><a class="button-primary" href="http://www.ithemes.com/security" target="_blank">' . __( 'Get Support and Pro Features', 'it-l10n-ithemes-security-pro' ) . '</a></p>';
		echo '</div>';
		echo '</div>';
	...
	public function metabox_need_help() {
		...
		echo '<p>' . __( 'Be sure your site has been properly secured by having one of our security experts tailor iThemes Security settings to the specific needs of this site.', 'it-l10n-ithemes-security-pro' ) . '</p>';
