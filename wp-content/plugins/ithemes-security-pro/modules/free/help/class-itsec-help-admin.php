...
class ITSEC_Help_Admin {
	...
	public function add_help_intro() {
		...
		echo '<p><strong>' . __( 'Have a Pro Secure Your Site', 'it-l10n-ithemes-security-pro' ) . '</strong><br />';
		echo __( 'Be sure your site has been properly secured by having one of our security experts tailor your security settings to the specific needs of your site.', 'it-l10n-ithemes-security-pro' ) . '</p>';
		...
		echo __( 'Has your site been hacked? Contact one of our recommended hack repair partners to get things back in order.', 'it-l10n-ithemes-security-pro' ) . '</p>';
		echo '<p><a class="button-secondary" href="http://ithemes.com/security/wordpress-hack-repair" target="_blank">' . __( 'Get hack repair', 'it-l10n-ithemes-security-pro' ) . '</a></p>';
