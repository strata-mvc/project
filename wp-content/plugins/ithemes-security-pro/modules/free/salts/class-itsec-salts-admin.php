...
class ITSEC_Salts_Admin {
	...
	public function itsec_add_dashboard_status( $statuses ) {
		...
		if ( false === $last_update ) {
			...
			$status_array = 'low';
			$status       = array(
				'text' => __( 'Your WordPress Salts have not been changed. You should change them now.', 'it-l10n-ithemes-security-pro' ),
			...
			$status_array = 'low';
			$status       = array(
				'text' => __( 'Your WordPress Salts have not been changed 30 days. You should change them now.', 'it-l10n-ithemes-security-pro' ),
				'link' => '#itsec_enable_salts', 'advanced' => true,
			);
			...
			$status       = array(
				'text' => __( 'You have recently changed your WordPress Salts.', 'it-l10n-ithemes-security-pro' ),
				'link' => '#itsec_enable_salts', 'advanced' => true,
			);
