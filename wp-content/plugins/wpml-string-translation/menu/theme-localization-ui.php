...
$theme_localization_stats_data = isset($theme_localization_stats[ $tl_domain ? 'theme ' . $tl_domain : 'theme' ]) ? $theme_localization_stats[ $tl_domain ? 'theme ' . $tl_domain : 'theme' ] : false;
