...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    ...
    window._gsDefine("TweenMax", [ "core.Animation", "core.SimpleTimeline", "TweenLite" ], function(a, b, c) {
        ...
        }, f = 1e-10, g = c._internals.isSelector, h = c._internals.isArray, i = e.prototype = c.to({}, .1, {}), j = [];
        e.version = "1.11.6", i.constructor = e, i.kill()._gc = !1, e.killTweensOf = e.killDelayedCallsTo = c.killTweensOf, 
        e.getTweensOf = c.getTweensOf, e.ticker = c.ticker, i.invalidate = function() {
            ...
            if (this._initted) if (b) this._initted = !1; else if (this._gc && this._enabled(!0, !1), 
            ...
            if (a >= n ? (this._totalTime = n, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, 
            ...
            e = "onComplete"), 0 === r && (m = this._rawPrevTime, this._startTime === this._timeline._duration && (a = 0), 
            (0 === a || 0 > m || m === f) && m !== a && (c = !0, m > f && (e = "onReverseComplete")), 
            this._rawPrevTime = m = !b || a || this._rawPrevTime === a ? a : f)) : 1e-7 > a ? (this._totalTime = this._time = this._cycle = 0, 
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== p || 0 === r && this._rawPrevTime > 0 && this._rawPrevTime !== f) && (e = "onReverseComplete", 
            d = this._reversed), 0 > a ? (this._active = !1, 0 === r && (this._rawPrevTime >= 0 && (c = !0), 
            this._rawPrevTime = m = !b || a || this._rawPrevTime === a ? a : f)) : this._initted || (c = !0)) : (this._totalTime = this._time = a, 
            0 !== this._repeat && (h = r + this._repeatDelay, this._cycle = this._totalTime / h >> 0, 
            0 !== this._cycle && this._cycle === this._totalTime / h && this._cycle--, this._time = this._totalTime - this._cycle * h, 
            this._yoyo && 0 !== (1 & this._cycle) && (this._time = r - this._time), this._time > r ? this._time = r : 0 > this._time && (this._time = 0)), 
            this._easeType ? (i = this._time / r, k = this._easeType, l = this._easePower, (1 === k || 3 === k && i >= .5) && (i = 1 - i), 
            3 === k && (i *= 2), 1 === l ? i *= i : 2 === l ? i *= i * i : 3 === l ? i *= i * i * i : 4 === l && (i *= i * i * i * i), 
            this.ratio = 1 === k ? 1 - i : 2 === k ? i : .5 > this._time / r ? i / 2 : 1 - i / 2) : this.ratio = this._ease.getRatio(this._time / r)), 
            o === this._time && !c && q === this._cycle) return p !== this._totalTime && this._onUpdate && (b || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || j)), 
            void 0;
            if (!this._initted) {
            ...
            g = this._firstPT; g; ) g.f ? g.t[g.p](g.c * this.ratio + g.s) : g.t[g.p] = g.c * this.ratio + g.s, 
            g = g._next;
            ...
            for (h(a) || ("string" == typeof a && (a = c.selector(a) || a), g(a) && (a = d.call(a, 0))), 
            n = a.length, p = 0; n > p; p++) {
                o = {};
                for (q in f) o[q] = f[q];
        ...
        var k = function(a, b) {
            ...
            d = d.concat(k(f, b)), e = d.length), f = f._next;
            return d;
        ...
        e.killAll = function(a, c, d, e) {
            ...
            if (null != a) {
                ...
                if ("string" == typeof a && (a = c.selector(a) || a), g(a) && (a = d.call(a, 0)), 
                h(a)) for (k = a.length; --k > -1; ) e.killChildTweensOf(a[k], b); else {
                    f = [];
                    for (j in m) for (i = m[j].target.parentNode; i; ) i === a && (f = f.concat(m[j].tweens)), 
                    i = i.parentNode;
                    for (l = f.length, k = 0; l > k; k++) b && f[k].totalTime(f[k].totalDuration()), 
                    f[k]._enabled(!1, !1);
                }
            }
        };
        ...
        }, e = 1e-10, f = c._internals.isSelector, g = c._internals.isArray, h = [], i = function(a) {
            var b, c = {};
            for (b in a) c[b] = a[b];
            return c;
        }, j = function(a, b, c, d) {
            a._timeline.pause(a._startTime), b && b.apply(d || a._timeline, c || h);
        }, k = h.slice, l = d.prototype = new b();
        return d.version = "1.11.6", l.constructor = d, l.kill()._gc = !1, l.to = function(a, b, d, e) {
            ...
            for ("string" == typeof a && (a = c.selector(a) || a), f(a) && (a = k.call(a, 0)), 
            g = g || 0, n = 0; a.length > n; n++) e.startAt && (e.startAt = i(e.startAt)), o.to(a[n], b, i(e), n * g);
            return this.add(o, h);
            ...
            if ("number" != typeof f && (f = this._parseTimeOrLabel(f, 0, !0, e)), !(e instanceof a)) {
                if (e instanceof Array || e && e.push && g(e)) {
                    for (h = h || "normal", i = i || 0, j = f, k = e.length, l = 0; k > l; l++) g(m = e[l]) && (m = new d({
                        tweens: m
                    })), this.add(m, j), "string" != typeof m && "function" != typeof m && ("sequence" === h ? j = m._startTime + m.totalDuration() / m._timeScale : "start" === h && (m._startTime -= m.delay())), 
                    j += i;
            ...
            var f;
            if (e instanceof a && e.timeline === this) this.remove(e); else if (e && (e instanceof Array || e.push && g(e))) for (f = e.length; --f > -1; ) e[f] instanceof a && e[f].timeline === this && this.remove(e[f]);
            ...
            if (a >= k ? (this._totalTime = this._time = k, this._reversed || this._hasPausedChild() || (f = !0, 
            i = "onComplete", 0 === this._duration && (0 === a || 0 > this._rawPrevTime || this._rawPrevTime === e) && this._rawPrevTime !== a && this._first && (j = !0, 
            this._rawPrevTime > e && (i = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, 
            a = k + 1e-4) : 1e-7 > a ? (this._totalTime = this._time = 0, (0 !== l || 0 === this._duration && this._rawPrevTime !== e && (this._rawPrevTime > 0 || 0 > a && this._rawPrevTime >= 0)) && (i = "onReverseComplete", 
            f = this._reversed), 0 > a ? (this._active = !1, 0 === this._duration && this._rawPrevTime >= 0 && this._first && (j = !0), 
            this._rawPrevTime = a) : (this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, 
            a = 0, this._initted || (j = !0))) : this._totalTime = this._time = this._rawPrevTime = a, 
            this._time !== l && this._first || c || j) {
                if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== l && a > 0 && (this._active = !0), 
                0 === l && this.vars.onStart && 0 !== this._time && (b || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || h)), 
                this._time >= l) for (d = this._first; d && (g = d._next, !this._paused || o); ) (d._active || d._startTime <= this._time && !d._paused && !d._gc) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), 
                d = g; else for (d = this._last; d && (g = d._prev, !this._paused || o); ) (d._active || l >= d._startTime && !d._paused && !d._gc) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), 
                d = g;
                ...
                this._active = !1), !b && this.vars[i] && this.vars[i].apply(this.vars[i + "Scope"] || this, this.vars[i + "Params"] || h)));
            }
        ...
        }, e = 1e-10, f = [], g = new c(null, null, 1, 0), h = d.prototype = new a();
        return h.constructor = d, h.kill()._gc = !1, d.version = "1.11.6", h.invalidate = function() {
            return this._yoyo = this.vars.yoyo === !0, this._repeat = this.vars.repeat || 0, 
            ...
            for (e in c) i[e] = c[e];
            return i.time = this._parseTimeOrLabel(a), d = Math.abs(Number(i.time) - this._time) / this._timeScale || .001, 
            h = new b(this, d, i), i.onStart = function() {
                h.target.paused(!0), h.vars.time !== h.target.time() && d === h.duration() && h.duration(Math.abs(h.vars.time - h.target.time()) / h.target._timeScale), 
            ...
            if (a >= l ? (this._locked || (this._totalTime = l, this._cycle = this._repeat), 
            this._reversed || this._hasPausedChild() || (g = !0, i = "onComplete", 0 === this._duration && (0 === a || 0 > r || r === e) && r !== a && this._first && (j = !0, 
            r > e && (i = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, 
            this._yoyo && 0 !== (1 & this._cycle) ? this._time = a = 0 : (this._time = m, a = m + 1e-4)) : 1e-7 > a ? (this._locked || (this._totalTime = this._cycle = 0), 
            this._time = 0, (0 !== n || 0 === m && r !== e && (r > 0 || 0 > a && r >= 0) && !this._locked) && (i = "onReverseComplete", 
            g = this._reversed), 0 > a ? (this._active = !1, 0 === m && r >= 0 && this._first && (j = !0), 
            this._rawPrevTime = a) : (this._rawPrevTime = m || !b || a || this._rawPrevTime === a ? a : e, 
            a = 0, this._initted || (j = !0))) : (0 === m && 0 > r && (j = !0), this._time = this._rawPrevTime = a, 
            this._locked || (this._totalTime = a, 0 !== this._repeat && (k = m + this._repeatDelay, 
            this._cycle = this._totalTime / k >> 0, 0 !== this._cycle && this._cycle === this._totalTime / k && this._cycle--, 
            this._time = this._totalTime - this._cycle * k, this._yoyo && 0 !== (1 & this._cycle) && (this._time = m - this._time), 
            this._time > m ? (this._time = m, a = m + 1e-4) : 0 > this._time ? this._time = a = 0 : a = this._time))), 
            this._cycle !== t && !this._locked) {
                var u = this._yoyo && 0 !== (1 & t), v = u === (this._yoyo && 0 !== (1 & this._cycle)), w = this._totalTime, x = this._cycle, y = this._rawPrevTime, z = this._time;
                if (this._totalTime = t * m, t > this._cycle ? u = !u : this._totalTime += m, this._time = n, 
                this._rawPrevTime = 0 === m ? r - 1e-4 : r, this._cycle = t, this._locked = !0, 
                n = u ? 0 : m, this.render(n, b, 0 === m), b || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || f), 
                v && (n = u ? m + 1e-4 : -1e-4, this.render(n, !0, !1)), this._locked = !1, this._paused && !s) return;
                this._time = z, this._totalTime = w, this._cycle = x, this._rawPrevTime = y;
            }
            if (!(this._time !== n && this._first || c || j)) return o !== this._totalTime && this._onUpdate && (b || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || f)), 
            void 0;
            if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== o && a > 0 && (this._active = !0), 
            0 === o && this.vars.onStart && 0 !== this._totalTime && (b || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || f)), 
            this._time >= n) for (d = this._first; d && (h = d._next, !this._paused || s); ) (d._active || d._startTime <= this._time && !d._paused && !d._gc) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), 
            d = h; else for (d = this._last; d && (h = d._prev, !this._paused || s); ) (d._active || n >= d._startTime && !d._paused && !d._gc) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), 
            d = h;
            ...
            this._active = !1), !b && this.vars[i] && this.vars[i].apply(this.vars[i + "Scope"] || this, this.vars[i + "Params"] || f)));
        ...
        i.constructor = g, g.version = "1.11.6", g.API = 2, g.defaultTransformPerspective = 0, 
        ...
        var j, k, l, m, n, o, p = /(?:\d|\-\d|\.\d|\-\.\d)+/g, q = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, r = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, s = /[^\d\-\.]/g, t = /(?:\d|\-|\+|=|#|\.)*/g, u = /opacity *= *([^)]*)/, v = /opacity:([^;]*)/, w = /alpha\(opacity *=.+?\)/i, x = /^(rgb|hsl)/, y = /([A-Z])/g, z = /-([a-z])/gi, A = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, B = function(a, b) {
            ...
            f = a || c.length ? a : c[b]) : a.currentStyle && (f = a.currentStyle[b]), null == e || f && "none" !== f && "auto" !== f && "auto auto" !== f ? f : e) : P(a);
        }, W = M.convertToPixels = function(a, b, c, d, e) {
            if ("px" === d || !d) return c;
            if ("auto" === d || !c) return 0;
            var f, g = C.test(b), h = a, i = K.style, j = 0 > c;
            return j && (c = -c), "%" === d && -1 !== b.indexOf("border") ? f = c / 100 * (g ? a.clientWidth : a.clientHeight) : (i.cssText = "border:0 solid red;position:" + V(a, "position") + ";line-height:0;", 
            ...
            return O || (e.opacity = P(a)), d = yb(a, b, !1), e.rotation = d.rotation, e.skewX = d.skewX, 
        ...
        var sb = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","), tb = T("transform"), ub = R + "transform", vb = T("transformOrigin"), wb = null !== T("perspective"), xb = M.Transform = function() {
            this.skewY = 0;
        }, yb = M.getTransform = function(a, b, c, d) {
            if (a._gsTransform && c && !d) return a._gsTransform;
            var e, f, h, i, j, k, l, m, n, o, p, q, r, s = c ? a._gsTransform || new xb() : new xb(), t = 0 > s.scaleX, u = 2e-5, v = 1e5, w = 179.99, x = w * G, y = wb ? parseFloat(V(a, vb, b, !1, "0 0 0").split(" ")[2]) || s.zOrigin || 0 : 0;
            for (tb ? e = V(a, ub, b, !0) : a.currentStyle && (e = a.currentStyle.filter.match(D), 
            e = e && 4 === e.length ? [ e[0].substr(4), Number(e[2].substr(4)), Number(e[1].substr(4)), e[3].substr(4), s.x || 0, s.y || 0 ].join(",") : ""), 
            f = (e || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], h = f.length; --h > -1; ) i = Number(f[h]), 
            f[h] = (j = i - (i |= 0)) ? (0 | j * v + (0 > j ? -.5 : .5)) / v + i : i;
            if (16 === f.length) {
                var z = f[8], A = f[9], B = f[10], C = f[12], E = f[13], F = f[14];
                if (s.zOrigin && (F = -s.zOrigin, C = z * F - f[12], E = A * F - f[13], F = B * F + s.zOrigin - f[14]), 
                !c || d || null == s.rotationX) {
                    var I, J, K, L, M, N, O, P = f[0], Q = f[1], R = f[2], S = f[3], T = f[4], U = f[5], W = f[6], X = f[7], Y = f[11], Z = Math.atan2(W, B), $ = -x > Z || Z > x;
                    s.rotationX = Z * H, Z && (L = Math.cos(-Z), M = Math.sin(-Z), I = T * L + z * M, 
                    J = U * L + A * M, K = W * L + B * M, z = T * -M + z * L, A = U * -M + A * L, B = W * -M + B * L, 
                    Y = X * -M + Y * L, T = I, U = J, W = K), Z = Math.atan2(z, P), s.rotationY = Z * H, 
                    Z && (N = -x > Z || Z > x, L = Math.cos(-Z), M = Math.sin(-Z), I = P * L - z * M, 
                    J = Q * L - A * M, K = R * L - B * M, A = Q * M + A * L, B = R * M + B * L, Y = S * M + Y * L, 
                    P = I, Q = J, R = K), Z = Math.atan2(Q, U), s.rotation = Z * H, Z && (O = -x > Z || Z > x, 
                    L = Math.cos(-Z), M = Math.sin(-Z), P = P * L + T * M, J = Q * L + U * M, U = Q * -M + U * L, 
                    W = R * -M + W * L, Q = J), O && $ ? s.rotation = s.rotationX = 0 : O && N ? s.rotation = s.rotationY = 0 : N && $ && (s.rotationY = s.rotationX = 0), 
                    s.scaleX = (0 | Math.sqrt(P * P + Q * Q) * v + .5) / v, s.scaleY = (0 | Math.sqrt(U * U + A * A) * v + .5) / v, 
                    s.scaleZ = (0 | Math.sqrt(W * W + B * B) * v + .5) / v, s.skewX = 0, s.perspective = Y ? 1 / (0 > Y ? -Y : Y) : 0, 
                    s.x = C, s.y = E, s.z = F;
                }
            } else if (!(wb && !d && f.length && s.x === f[4] && s.y === f[5] && (s.rotationX || s.rotationY) || void 0 !== s.x && "none" === V(a, "display", b))) {
                var _ = f.length >= 6, ab = _ ? f[0] : 1, bb = f[1] || 0, cb = f[2] || 0, db = _ ? f[3] : 1;
                s.x = f[4] || 0, s.y = f[5] || 0, k = Math.sqrt(ab * ab + bb * bb), l = Math.sqrt(db * db + cb * cb), 
                m = ab || bb ? Math.atan2(bb, ab) * H : s.rotation || 0, n = cb || db ? Math.atan2(cb, db) * H + m : s.skewX || 0, 
                o = k - Math.abs(s.scaleX || 0), p = l - Math.abs(s.scaleY || 0), Math.abs(n) > 90 && 270 > Math.abs(n) && (t ? (k *= -1, 
                n += 0 >= m ? 180 : -180, m += 0 >= m ? 180 : -180) : (l *= -1, n += 0 >= n ? 180 : -180)), 
                q = (m - s.rotation) % 180, r = (n - s.skewX) % 180, (void 0 === s.skewX || o > u || -u > o || p > u || -u > p || q > -w && w > q && false | q * v || r > -w && w > r && false | r * v) && (s.scaleX = k, 
                s.scaleY = l, s.rotation = m, s.skewX = n), wb && (s.rotationX = s.rotationY = s.z = 0, 
                s.perspective = parseFloat(g.defaultTransformPerspective) || 0, s.scaleZ = 1);
            }
            s.zOrigin = y;
        ...
        }, Ab = M.set3DTransformRatio = function() {
            ...
            if (A || y.skewX) s = Math.cos(A), t = Math.sin(A), a = s, e = t, y.skewX && (A -= y.skewX * G, 
            s = Math.cos(A), t = Math.sin(A), "simple" === y.skewType && (u = Math.tan(y.skewX * G), 
            u = Math.sqrt(1 + u * u), s *= u, t *= u)), b = -t, f = s; else {
                if (!(y.rotationY || y.rotationX || 1 !== D || E)) return z[tb] = "translate3d(" + y.x + "px," + y.y + "px," + y.z + "px)" + (1 !== B || 1 !== C ? " scale(" + B + "," + C + ")" : ""), 
                void 0;
                a = f = 1, b = e = 0;
            }
            k = 1, c = d = g = h = i = j = l = n = o = 0, p = E ? -1 / E : 0, q = y.zOrigin, 
            r = 1e5, A = y.rotationY * G, A && (s = Math.cos(A), t = Math.sin(A), i = k * -t, 
            n = p * -t, c = a * t, g = e * t, k *= s, p *= s, a *= s, e *= s), A = y.rotationX * G, 
            A && (s = Math.cos(A), t = Math.sin(A), u = b * s + c * t, v = f * s + g * t, w = j * s + k * t, 
            x = o * s + p * t, c = b * -t + c * s, g = f * -t + g * s, k = j * -t + k * s, p = o * -t + p * s, 
            b = u, f = v, j = w, o = x), 1 !== D && (c *= D, g *= D, k *= D, p *= D), 1 !== C && (b *= C, 
            f *= C, j *= C, o *= C), 1 !== B && (a *= B, e *= B, i *= B, n *= B), q && (l -= q, 
            d = c * l, h = g * l, l = k * l + q), d = (u = (d += y.x) - (d |= 0)) ? (0 | u * r + (0 > u ? -.5 : .5)) / r + d : d, 
            h = (u = (h += y.y) - (h |= 0)) ? (0 | u * r + (0 > u ? -.5 : .5)) / r + h : h, 
            l = (u = (l += y.z) - (l |= 0)) ? (0 | u * r + (0 > u ? -.5 : .5)) / r + l : l, 
            z[tb] = "matrix3d(" + [ (0 | a * r) / r, (0 | e * r) / r, (0 | i * r) / r, (0 | n * r) / r, (0 | b * r) / r, (0 | f * r) / r, (0 | j * r) / r, (0 | o * r) / r, (0 | c * r) / r, (0 | g * r) / r, (0 | k * r) / r, (0 | p * r) / r, d, h, l, E ? 1 + -l / E : 1 ].join(",") + ")";
        }, Bb = M.set2DTransformRatio = function(a) {
            var b, c, d, e, f, g = this.data, h = this.t, i = h.style;
            return g.rotationX || g.rotationY || g.z || g.force3D ? (this.setRatio = Ab, Ab.call(this, a), 
            void 0) : (g.rotation || g.skewX ? (b = g.rotation * G, c = b - g.skewX * G, d = 1e5, 
            e = g.scaleX * d, f = g.scaleY * d, i[tb] = "matrix(" + (0 | Math.cos(b) * e) / d + "," + (0 | Math.sin(b) * e) / d + "," + (0 | Math.sin(c) * -f) / d + "," + (0 | Math.cos(c) * f) / d + "," + g.x + "," + g.y + ")") : i[tb] = "matrix(" + g.scaleX + ",0,0," + g.scaleY + "," + g.x + "," + g.y + ")", 
            void 0);
        };
        qb("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType", {
            parser: function(a, b, c, d, f, h, i) {
                ...
                if ("string" == typeof u.transform && tb) l = r.cssText, r[tb] = u.transform, r.display = "block", 
                j = yb(a, null, !1), r.cssText = l; else if ("object" == typeof u) {
                    if (j = {
                    ...
                    wb && (j.rotationX = eb("rotationX" in u ? u.rotationX : "shortRotationX" in u ? u.shortRotationX + "_short" : q.rotationX || 0, q.rotationX, "rotationX", v), 
                ...
                for (wb && null != u.force3D && (q.force3D = u.force3D, o = !0), q.skewType = u.skewType || q.skewType || g.defaultSkewType, 
                n = q.force3D || q.z || q.rotationX || q.rotationY || j.z || j.rotationX || j.rotationY || j.perspective, 
                n || null == u.scale || (j.scaleZ = 1); --t > -1; ) c = sb[t], m = j[c] - q[c], 
                (m > s || -s > m || null != I[c]) && (o = !0, f = new mb(q, c, q[c], m, f), c in v && (f.e = v[c]), 
                f.xs0 = 0, f.plugin = h, d._overwriteProps.push(f.n));
                return m = u.transformOrigin, (m || wb && n && q.zOrigin) && (tb ? (o = !0, c = vb, 
                m = (m || V(a, c, e, !1, "50% 50%")) + "", f = new mb(r, c, 0, 0, f, -1, "transformOrigin"), 
                f.b = r[c], f.plugin = h, wb ? (l = q.zOrigin, m = m.split(" "), q.zOrigin = (m.length > 2 && (0 === l || "0px" !== m[2]) ? parseFloat(m[2]) : l) || 0, 
                f.xs0 = f.e = r[c] = m[0] + " " + (m[1] || "50%") + " 0px", f = new mb(q, "zOrigin", 0, 0, f, -1, f.n), 
                f.b = l, f.xs0 = f.e = q.zOrigin) : f.xs0 = f.e = r[c] = m) : bb(m + "", q)), o && (d._transformType = n || 3 === this._transformType ? 3 : 2), 
                f;
            },
            prefix: !0
        }), qb("boxShadow", {
        ...
        qb("opacity,alpha,autoAlpha", {
            ...
            parser: function(a, b, c, d, f, g) {
                ...
                f.data = a, f.plugin = g, f.setRatio = Cb), j && (f = new mb(i, "visibility", 0, 0, f, -1, null, !1, 0, 0 !== h ? "inherit" : "hidden", 0 === b ? "hidden" : "inherit"), 
        ...
        var Db = function(a, b) {
            ...
            if (this.t._gsClassPT = this, 1 === a || 0 === a) {
                ...
                for (var b = this.data, c = this.t.style; b; ) b.v ? c[b.p] = b.v : Db(c, b.p), 
                b = b._next;
        ...
        qb("className", {
            parser: function(a, b, d, f, g, h, i) {
                ...
                if (g = f._classNamePT = new mb(a, d, 0, 0, g, 2), g.setRatio = Eb, g.pr = -11, 
        ...
        var Fb = function(a) {
            if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                if ("all" === this.e) f.cssText = "", e = !0; else for (b = this.e.split(","), d = b.length; --d > -1; ) c = b[d], 
                h[c] && (h[c].parse === g ? e = !0 : c = "transformOrigin" === c ? vb : h[c].p), 
                Db(f, c);
        ...
        for (qb("clearProps", {
            parser: function(a, b, d, e, f) {
                return f = new mb(a, d, 0, 0, f, 2), f.setRatio = Fb, f.e = b, f.pr = -10, f.data = e._tween, 
                c = !0, f;
            }
        ...
        i = g.prototype, i._firstPT = null, i._onInitTween = function(a, b, h) {
            ...
            this._transformType) {
                ...
                t = new mb(a, "transform", 0, 0, null, 2), this._linkCSSP(t, null, o), t.setRatio = u && wb ? Ab : tb ? Bb : zb, 
                t.data = this._transform || yb(a, e, !0), f.pop();
            }
            if (c) {
                for (;m; ) {
            ...
            n = l || 0 === l ? (r ? l + k : l) + p : b[g], o !== p && "" !== p && (l || 0 === l) && (k || 0 === k) && (k = W(a, g, k, o), 
            "%" === p ? (k /= W(a, g, 100, "%") / 100, b.strictUnits !== !0 && (m = k + "%")) : "em" === p ? k /= W(a, g, 1, "em") : (l = W(a, g, l, p), 
        ...
        var Gb = function(a, b, c) {
            var d, e, f, g;
            if (a.slice) for (e = a.length; --e > -1; ) Gb(a[e], b, c); else for (d = a.childNodes, 
            e = d.length; --e > -1; ) f = d[e], g = f.type, f.style && (b.push(Y(f)), c && c.push(f)), 
            1 !== g && 9 !== g && 11 !== g || !f.childNodes.length || Gb(f, b, c);
        };
        return g.cascadeTo = function(a, c, d) {
            var e, f, g, h = b.to(a, c, d), i = [ h ], j = [], k = [], l = [], m = b._internals.reservedProps;
            for (a = h._targets || h.target, Gb(a, j, l), h.render(c, !0), Gb(a, k), h.render(0, !0), 
    ...
    if (!b.TweenLite) {
        var c, d, e, f, g, h = function(a) {
            ...
            this.check = function(i) {
                for (var j, k, l, m, p = d.length, q = p; --p > -1; ) (j = n[d[p]] || new o(d[p], [])).gsClass ? (g[p] = j.gsClass, 
                q--) : i && j.sc.push(this);
                if (0 === q && e) for (k = ("com.greensock." + c).split("."), l = k.pop(), m = h(k.join("."))[l] = this.gsClass = e.apply(e, g), 
                f && (b[l] = m, "function" == typeof define && define.amd ? define((a.GreenSockAMDPath ? a.GreenSockAMDPath + "/" : "") + c.split(".").join("/"), [], function() {
                    return m;
        ...
        var r = [ 0, 0, 1, 1 ], s = [], t = q("easing.Ease", function(a, b, c, d) {
            ...
            e = d ? q("easing." + f, null, !0) : i.easing[f] || {}, g = l.length; --g > -1; ) h = l[g], 
        ...
        }, c = [ "Linear", "Quad", "Cubic", "Quart", "Quint,Strong" ], d = c.length; --d > -1; ) e = c[d] + ",Power" + d, 
        v(new t(null, null, 1, d), e, "easeOut", !0), v(new t(null, null, 2, d), e, "easeIn" + (0 === d ? ",easeNone" : "")), 
        ...
        for (c = [ "ms", "moz", "webkit", "o" ], d = c.length; --d > -1 && !x; ) x = a[c[d] + "RequestAnimationFrame"], 
        ...
        q("Ticker", function(a, b) {
            var c, d, e, h, i, j = this, k = z(), m = b !== !1 && x, n = function(a) {
                A = z(), j.time = (A - k) / 1e3;
                var b, f = j.time - i;
                (!c || f > 0 || a === !0) && (j.frame++, i += f + (f >= h ? .004 : h - f), b = !0), 
                a !== !0 && (e = d(n)), b && j.dispatchEvent("tick");
            };
        ...
        var B = q("core.Animation", function(a, b) {
            ...
            this._reversed = b.reversed === !0, O) {
                g || f.wake();
                var c = this.vars.useFrames ? N : O;
                c.add(this, c._time), this.vars.paused && this.paused(!0);
            }
        });
        f = B.ticker = new i.Ticker(), e = B.prototype, e._dirty = e._gc = e._initted = e._paused = !1, 
        e._totalTime = e._time = 0, e._rawPrevTime = -1, e._next = e._last = e._onUpdate = e._timeline = e.timeline = null, 
        e._paused = !1;
        var C = function() {
        ...
        C(), e.play = function(a, b) {
            ...
            return g || f.wake(), this._gc = !a, this._active = this.isActive(), b !== !0 && (a && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !a && this.timeline && this._timeline._remove(this, !0)), 
            !1;
        }, e._kill = function() {
            ...
            if ("on" === (a || "").substr(0, 2)) {
                ...
                null == b ? delete e[a] : (e[a] = b, e[a + "Params"] = m(c) && -1 !== c.join("").indexOf("{self}") ? this._swapSelfInParams(c) : c, 
        ...
        e = D.prototype = new B(), e.constructor = D, e.kill()._gc = !1, e._first = e._last = null, 
        e._sortChildren = !1, e.add = e.insert = function(a, b) {
            var c, d;
        ...
        var E = q("TweenLite", function(b, c, d) {
            ...
            (h || b instanceof Array || b.push && m(b)) && "number" != typeof b[0]) for (this._targets = g = k.call(b, 0), 
            ...
            this._siblings = P(b, this, !1), 1 === i && this._siblings.length > 1 && Q(b, this, null, 1, this._siblings);
            ...
            var c, d = {};
            for (c in a) L[c] || c in b && "x" !== c && "y" !== c && "width" !== c && "height" !== c && "className" !== c && "border" !== c || !(!I[c] || I[c] && I[c]._autoCSS) || (d[c] = a[c], 
            delete a[c]);
            a.css = d;
        };
        e = E.prototype = new B(), e.constructor = E, e.kill()._gc = !1, e.ratio = 0, e._firstPT = e._targets = e._overwrittenProps = e._startAt = null, 
        e._notifyPluginsOfEnabled = !1, E.version = "1.11.6", E.defaultEase = e._ease = new t(null, null, 1, 1), 
        E.defaultOverwrite = "auto", E.ticker = f, E.autoSleep = !0, E.selector = a.$ || a.jQuery || function(b) {
        ...
        O._startTime = f.time, N._startTime = f.frame, O._active = N._active = !0, B._updateRoot = function() {
            if (O.render((f.time - O._startTime) * O._timeScale, !1, !1), N.render((f.frame - N._startTime) * N._timeScale, !1, !1), 
            !(f.frame % 120)) {
                var a, b, c;
                for (c in J) {
        ...
        var P = function(a, b, c) {
            ...
            for (f = e.length; --f > -1; ) (h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (k = k || R(b, 0, o), 
        ...
        e._init = function() {
            ...
            if (e.startAt) {
                if (this._startAt && this._startAt.render(-1, !0), e.startAt.overwrite = 0, e.startAt.immediateRender = !0, 
                this._startAt = E.to(this.target, 0, e.startAt), h) if (this._time > 0) this._startAt = null; else if (0 !== g) return;
            } else if (e.runBackwards && 0 !== g) if (this._startAt) this._startAt.render(-1, !0), 
            this._startAt = null; else {
                c = {};
                for (d in e) L[d] && "autoCSS" !== d || (c[d] = e[d]);
                if (c.overwrite = 0, c.data = "isFromStart", this._startAt = E.to(this.target, 0, c), 
                e.immediateRender) {
            ...
            if (b && E._onPluginEvent("_onInitAllProps", this), f && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), 
            ...
            this._reversed || (d = !0, e = "onComplete"), 0 === i && (g = this._rawPrevTime, 
            this._startTime === this._timeline._duration && (a = 0), (0 === a || 0 > g || g === j) && g !== a && (c = !0, 
            g > j && (e = "onReverseComplete")), this._rawPrevTime = g = !b || a || this._rawPrevTime === a ? a : j); else if (1e-7 > a) this._totalTime = this._time = 0, 
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== h || 0 === i && this._rawPrevTime > 0 && this._rawPrevTime !== j) && (e = "onReverseComplete", 
            d = this._reversed), 0 > a ? (this._active = !1, 0 === i && (this._rawPrevTime >= 0 && (c = !0), 
            this._rawPrevTime = g = !b || a || this._rawPrevTime === a ? a : j)) : this._initted || (c = !0); else if (this._totalTime = this._time = a, 
            this._easeType) {
            ...
            return this._notifyPluginsOfEnabled && E._onPluginEvent("_onDisable", this), this._firstPT = null, 
        ...
        var S = q("plugins.TweenPlugin", function(a, b) {
            ...
            this._priority = b || 0, this._super = S.prototype;
        }, !0);
        if (e = S.prototype, S.version = "1.10.1", S.API = 2, e._firstPT = null, e._addTween = function(a, b, c, d, e, f) {
            ...
            for (var b, c = this._firstPT, d = 1e-6; c; ) b = c.c * a + c.s, c.r ? b = 0 | b + (b > 0 ? .5 : -.5) : d > b && b > -d && (b = 0), 
...
(function(a) {
    function b(b, c) {
        var d, e, f = this, g = navigator.userAgent.toLowerCase();
        f.uid = a.rsModules.uid++;
        f.ns = ".rs" + f.uid;
        var h = document.createElement("div").style, i = [ "webkit", "Moz", "ms", "O" ], j = "", k = 0;
        for (d = 0; d < i.length; d++) e = i[d], !j && e + "Transform" in h && (j = e), 
        e = e.toLowerCase(), window.requestAnimationFrame || (window.requestAnimationFrame = window[e + "RequestAnimationFrame"], 
        ...
        f.isIPAD = g.match(/(ipad)/);
        i = /(chrome)[ \/]([\w.]+)/.exec(g) || /(webkit)[ \/]([\w.]+)/.exec(g) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(g) || /(msie) ([\w.]+)/.exec(g) || 0 > g.indexOf("compatible") && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(g) || [];
        d = i[1] || "";
        e = i[2] || "0";
        i = {};
        d && (i[d] = !0, i.version = e);
        i.chrome && (i.webkit = !0);
        f._a = i;
        f.isAndroid = -1 < g.indexOf("android");
        f.slider = a(b);
        f.ev = a(f);
        f._b = a(document);
        f.st = a.extend({}, a.fn.royalSlider.defaults, c);
        f._c = f.st.transitionSpeed;
        f._d = 0;
        if (f.st.allowCSS3 && (!i.webkit || f.st.allowCSS3OnWebkit)) g = j + (j ? "T" : "t"), 
        f._e = g + "ransform" in h && g + "ransition" in h, f._e && (f._f = j + (j ? "P" : "p") + "erspective" in h);
        j = j.toLowerCase();
        f._g = "-" + j + "-";
        f._h = "vertical" === f.st.slidesOrientation ? !1 : !0;
        f._i = f._h ? "left" : "top";
        f._j = f._h ? "width" : "height";
        f._k = -1;
        f._l = "fade" === f.st.transitionType ? !1 : !0;
        f._l || (f.st.sliderDrag = !1, f._m = 10);
        f._n = "z-index:0; display:none; opacity:0;";
        f._o = 0;
        f._p = 0;
        f._q = 0;
        ...
        f.slides = [];
        f._r = 0;
        (f.st.slides ? a(f.st.slides) : f.slider.children().detach()).each(function() {
            f._s(this, !0);
        });
        ...
        f._t();
        f.st.startSlideId ? f.st.startSlideId > f.numSlides - 1 && (f.st.startSlideId = f.numSlides - 1) : f.st.startSlideId = 0;
        f._o = f.staticSlideId = f.currSlideId = f._u = f.st.startSlideId;
        f.currSlide = f.slides[f.currSlideId];
        f._v = 0;
        f.msTouch = !1;
        f.slider.addClass((f._h ? "rsHor" : "rsVer") + (f._l ? "" : " rsFade"));
        h = '<div class="rsOverflow"><div class="rsContainer">';
        f.slidesSpacing = f.st.slidesSpacing;
        f._w = (f._h ? f.slider.width() : f.slider.height()) + f.st.slidesSpacing;
        f._x = Boolean(0 < f._y);
        1 >= f.numSlides && (f._z = !1);
        f._a1 = f._z && f._l ? 2 === f.numSlides ? 1 : 2 : 0;
        f._b1 = 6 > f.numSlides ? f.numSlides : 6;
        f._c1 = 0;
        f._d1 = 0;
        f.slidesJQ = [];
        for (d = 0; d < f.numSlides; d++) f.slidesJQ.push(a('<div style="' + (f._l ? "" : d !== f.currSlideId ? f._n : "z-index:0;") + '" class="rsSlide "></div>'));
        f._e1 = h = a(h + "</div></div>");
        j = f.ns;
        f.msEnabled = window.navigator.msPointerEnabled;
        f.msEnabled ? (f.msTouch = Boolean(1 < window.navigator.msMaxTouchPoints), f.hasTouch = !1, 
        f._n1 = .2, f._j1 = "MSPointerDown" + j, f._k1 = "MSPointerMove" + j, f._l1 = "MSPointerUp" + j, 
        f._m1 = "MSPointerCancel" + j) : (f._j1 = "mousedown" + j, f._k1 = "mousemove" + j, 
        f._l1 = "mouseup" + j, f._m1 = "mouseup" + j, "ontouchstart" in window || "createTouch" in document ? (f.hasTouch = !0, 
        f._j1 += " touchstart" + j, f._k1 += " touchmove" + j, f._l1 += " touchend" + j, 
        f._m1 += " touchcancel" + j, f._n1 = .5, f.st.sliderTouch && (f._f1 = !0)) : (f.hasTouch = !1, 
        f._n1 = .2));
        f.st.sliderDrag && (f._f1 = !0, i.msie || i.opera ? f._g1 = f._h1 = "move" : i.mozilla ? (f._g1 = "-moz-grab", 
        f._h1 = "-moz-grabbing") : i.webkit && -1 != navigator.platform.indexOf("Mac") && (f._g1 = "-webkit-grab", 
        f._h1 = "-webkit-grabbing"), f._i1());
        f.slider.html(h);
        f._o1 = f.st.controlsInside ? f._e1 : f.slider;
        f._p1 = f._e1.children(".rsContainer");
        f.msEnabled && f._p1.css("-ms-touch-action", f._h ? "pan-y" : "pan-x");
        f._q1 = a('<div class="rsPreloader"></div>');
        h = f._p1.children(".rsSlide");
        f._r1 = f.slidesJQ[f.currSlideId];
        f._s1 = 0;
        f._e ? (f._t1 = "transition-property", f._u1 = "transition-duration", f._v1 = "transition-timing-function", 
        f._w1 = f._x1 = f._g + "transform", f._f ? (i.webkit && !i.chrome && f.slider.addClass("rsWebkit3d"), 
        /iphone|ipad|ipod/gi.test(navigator.appVersion), f._y1 = "translate3d(", f._z1 = "px, ", 
        f._a2 = "px, 0px)") : (f._y1 = "translate(", f._z1 = "px, ", f._a2 = "px)"), f._l ? f._p1[f._g + f._t1] = f._g + "transform" : (j = {}, 
        j[f._g + f._t1] = "opacity", j[f._g + f._u1] = f.st.transitionSpeed + "ms", j[f._g + f._v1] = f.st.css3easeInOut, 
        h.css(j))) : (f._x1 = "left", f._w1 = "top");
        var l;
        a(window).on("resize" + f.ns, function() {
            l && clearTimeout(l);
            l = setTimeout(function() {
                f.updateSliderSize();
            }, 50);
        });
        f.ev.trigger("rsAfterPropsSetup");
        f.updateSliderSize();
        f.st.keyboardNavEnabled && f._b2();
        if (f.st.arrowsNavHideOnTouch && (f.hasTouch || f.msTouch)) f.st.arrowsNav = !1;
        f.st.arrowsNav && (h = f._o1, a('<div class="rsArrow rsArrowLeft"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight"><div class="rsArrowIcn"></div></div>').appendTo(h), 
        f._c2 = h.children(".rsArrowLeft").click(function(a) {
            a.preventDefault();
            f.prev();
        }), f._d2 = h.children(".rsArrowRight").click(function(a) {
            a.preventDefault();
            f.next();
        }), f.st.arrowsNavAutoHide && !f.hasTouch && (f._c2.addClass("rsHidden"), f._d2.addClass("rsHidden"), 
        h.one("mousemove.arrowshover", function() {
            f._c2.removeClass("rsHidden");
            f._d2.removeClass("rsHidden");
        }), h.hover(function() {
            f._e2 || (f._c2.removeClass("rsHidden"), f._d2.removeClass("rsHidden"));
        }, function() {
            f._e2 || (f._c2.addClass("rsHidden"), f._d2.addClass("rsHidden"));
        })), f.ev.on("rsOnUpdateNav", function() {
            f._f2();
        }), f._f2());
        if (f._f1) f._p1.on(f._j1, function(a) {
            f._g2(a);
        }); else f.dragSuccess = !1;
        var m = [ "rsPlayBtnIcon", "rsPlayBtn", "rsCloseVideoBtn", "rsCloseVideoIcn" ];
        f._p1.click(function(b) {
            if (!f.dragSuccess) {
                var c = a(b.target).attr("class");
                if (-1 !== a.inArray(c, m) && f.toggleVideo()) return !1;
                if (f.st.navigateByClick && !f._h2) {
                    if (a(b.target).closest(".rsNoDrag", f._r1).length) return !0;
                    f._i2(b);
                }
                f.ev.trigger("rsSlideClick");
            }
        }).on("click.rs", "a", function() {
            if (f.dragSuccess) return !1;
            f._h2 = !0;
            setTimeout(function() {
                f._h2 = !1;
            }, 3);
    ...
    b.prototype = {
        constructor: b,
        _i2: function(a) {
            a = a[this._h ? "pageX" : "pageY"] - this._j2;
            a >= this._q ? this.next() : 0 > a && this.prev();
        },
        _t: function() {
            var a;
            a = this.st.numImagesToPreload;
            if (this._z = this.st.loop) 2 === this.numSlides ? (this._z = !1, this.st.loopRewind = !0) : 2 > this.numSlides && (this.st.loopRewind = this._z = !1);
            this._z && 0 < a && (4 >= this.numSlides ? a = 1 : this.st.numImagesToPreload > (this.numSlides - 1) / 2 && (a = Math.floor((this.numSlides - 1) / 2)));
            this._y = a;
        },
        _s: function(b, c) {
            function d(a, b) {
                b ? g.images.push(a.attr(b)) : g.images.push(a.text());
                if (i) {
                    i = !1;
                    g.caption = "src" === b ? a.attr("alt") : a.contents();
                    g.image = g.images[0];
                    g.videoURL = a.attr("data-rsVideo");
                    var c = a.attr("data-rsw"), d = a.attr("data-rsh");
                    "undefined" !== typeof c && !1 !== c && "undefined" !== typeof d && !1 !== d ? (g.iW = parseInt(c, 10), 
                    g.iH = parseInt(d, 10)) : e.st.imgWidth && e.st.imgHeight && (g.iW = e.st.imgWidth, 
                    g.iH = e.st.imgHeight);
                }
            }
            var e = this, f, g = {}, h, i = !0;
            b = a(b);
            e._k2 = b;
            e.ev.trigger("rsBeforeParseNode", [ b, g ]);
            if (!g.stopParsing) return b = e._k2, g.id = e._r, g.contentAdded = !1, e._r++, 
            g.images = [], g.isBig = !1, g.hasCover || (b.hasClass("rsImg") ? (h = b, f = !0) : (h = b.find(".rsImg"), 
            h.length && (f = !0)), f ? (g.bigImage = h.eq(0).attr("data-rsBigImg"), h.each(function() {
                var b = a(this);
                b.is("a") ? d(b, "href") : b.is("img") ? d(b, "src") : d(b);
            })) : b.is("img") && (b.addClass("rsImg rsMainSlideImage"), d(b, "src"))), h = b.find(".rsCaption"), 
            h.length && (g.caption = h.remove()), g.content = b, e.ev.trigger("rsAfterParseNode", [ b, g ]), 
            c && e.slides.push(g), 0 === g.images.length && (g.isLoaded = !0, g.isRendered = !1, 
            g.isLoading = !1, g.images = null), g;
        },
        _b2: function() {
            var a = this, b, c, d = function(b) {
                37 === b ? a.prev() : 39 === b && a.next();
            };
            a._b.on("keydown" + a.ns, function(e) {
                if (!a._l2 && (c = e.keyCode, (37 === c || 39 === c) && !b)) d(c), b = setInterval(function() {
                    d(c);
                }, 700);
            }).on("keyup" + a.ns, function() {
        ...
        _n2: function(b, c) {
            function d(c, d, g) {
                c.isAdded ? (e(d, c), f(d, c)) : (g || (g = h.slidesJQ[d]), c.holder ? g = c.holder : (g = h.slidesJQ[d] = a(g), 
                c.holder = g), c.appendOnLoaded = !1, f(d, c, g), e(d, c), h._p2(c, g, b), c.isAdded = !0);
            }
            function e(a, c) {
                c.contentAdded || (h.setItemHtml(c, b), b || (c.contentAdded = !0));
            }
            function f(a, b, c) {
                h._l && (c || (c = h.slidesJQ[a]), c.css(h._i, (a + h._d1 + n) * h._w));
            }
            function g(a) {
                if (k) {
            ...
            var h = this, i, j, k = h._z, l = h.numSlides;
            if (!isNaN(c)) return g(c);
            var m = h.currSlideId, n, o = b ? Math.abs(h._o2 - h.currSlideId) >= h.numSlides - 1 ? 0 : 1 : h._y, p = Math.min(2, o), q = !1, r = !1, s;
            for (j = m; j < m + 1 + p; j++) if (s = g(j), (i = h.slides[s]) && (!i.isAdded || !i.positionSet)) {
                q = !0;
                break;
            }
            for (j = m - 1; j > m - 1 - p; j--) if (s = g(j), (i = h.slides[s]) && (!i.isAdded || !i.positionSet)) {
                r = !0;
                break;
            }
            if (q) for (j = m; j < m + o + 1; j++) s = g(j), n = Math.floor((h._u - (m - j)) / h.numSlides) * h.numSlides, 
            (i = h.slides[s]) && d(i, s);
            if (r) for (j = m - 1; j > m - 1 - o; j--) s = g(j), n = Math.floor((h._u - (m - j)) / l) * l, 
            (i = h.slides[s]) && d(i, s);
            if (!b) {
                p = g(m - o);
                m = g(m + o);
                o = p > m ? 0 : p;
                for (j = 0; j < l; j++) if (!(p > m && j > p - 1) && (j < o || j > m)) if ((i = h.slides[j]) && i.holder) i.holder.detach(), 
                i.isAdded = !1;
            }
        },
        setItemHtml: function(b, c) {
            var d = this, e = function() {
                if (b.images) {
                    if (!b.isLoading) {
                        var c, e;
                        b.content.hasClass("rsImg") ? (c = b.content, e = !0) : c = b.content.find(".rsImg:not(img)");
                        ...
                        b.iW && b.iH && (b.isLoaded || d._q2(b), h());
                        b.isLoading = !0;
                        if (b.isBig) a("<img />").on("load.rs error.rs", function() {
                            ...
                            c = function() {
                                a(this).off("load.rs error.rs");
                                b.loaded.push(this);
                                b.loaded.length === b.numStartedLoad && f(b.loaded, !1);
                            };
                            for (var g = 0; g < b.images.length; g++) {
                                var i = a("<img />");
                                b.numStartedLoad++;
                                i.on("load.rs error.rs", c).attr("src", b.images[g]);
                            }
                        }
                    }
                ...
                if (a.length) {
                    var d = a[0];
                    if (c !== b.isBig) (d = b.holder.children()) && 1 < d.length && k(); else if (b.iW && b.iH) g(); else if (b.iW = d.width, 
                ...
                if (!b.isAppended && d.ev) {
                    var a = d.st.visibleNearby, e = b.id - d._o;
                    if (!c && !b.appendOnLoaded && d.st.fadeinLoadedSlide && (0 === e || (a || d._r2 || d._l2) && (-1 === e || 1 === e))) a = {
                        visibility: "visible",
                        opacity: 0
                    ...
                    b.isAppended = !0;
                    b.isLoaded && (d._q2(b), i());
                    b.sizeReady || (b.sizeReady = !0, setTimeout(function() {
                        d.ev.trigger("rsMaybeSizeReady", b);
                    }, 100));
                }
            }, i = function() {
                !b.loadedTriggered && d.ev && (b.isLoaded = b.loadedTriggered = !0, b.holder.trigger("rsAfterContentSet"), 
            ...
            b.isLoaded ? h() : c ? !d._l && b.images && b.iW && b.iH ? e() : (b.holder.isWaiting = !0, 
            j(), b.holder.slideId = -99) : e();
        },
        _p2: function(a) {
            this._p1.append(a.holder);
            a.appendOnLoaded = !1;
        },
        _g2: function(b, c) {
            var d = this, e, f = "touchstart" === b.type;
            d._s2 = f;
            d.ev.trigger("rsDragStart");
            if (a(b.target).closest(".rsNoDrag", d._r1).length) return d.dragSuccess = !1, !0;
            !c && d._r2 && (d._t2 = !0, d._u2());
            d.dragSuccess = !1;
            if (d._l2) f && (d._v2 = !0); else {
                f && (d._v2 = !1);
                d._w2();
                if (f) {
                    var g = b.originalEvent.touches;
                    if (g && 0 < g.length) e = g[0], 1 < g.length && (d._v2 = !0); else return;
                } else b.preventDefault(), e = b, d.msEnabled && (e = e.originalEvent);
                d._l2 = !0;
                d._b.on(d._k1, function(a) {
                    d._x2(a, c);
                }).on(d._l1, function(a) {
                    d._y2(a, c);
                });
                ...
                d._b3 = e.pageX;
                d._c3 = e.pageY;
                d._d3 = d._v = (!c ? d._h : d._e3) ? e.pageX : e.pageY;
                d._f3 = 0;
                d._g3 = 0;
                d._h3 = !c ? d._p : d._i3;
                d._j3 = new Date().getTime();
                if (f) d._e1.on(d._m1, function(a) {
                    d._y2(a, c);
                });
            }
        },
        _k3: function(a, b) {
            if (this._l3) {
                var c = this._m3, d = a.pageX - this._b3, e = a.pageY - this._c3, f = this._h3 + d, g = this._h3 + e, h = !b ? this._h : this._e3, f = h ? f : g, g = this._z2;
                this._a3 = !0;
                this._b3 = a.pageX;
                this._c3 = a.pageY;
                "x" === g && 0 !== d ? this._f3 = 0 < d ? 1 : -1 : "y" === g && 0 !== e && (this._g3 = 0 < e ? 1 : -1);
                g = h ? this._b3 : this._c3;
                d = h ? d : e;
                b ? f > this._n3 ? f = this._h3 + d * this._n1 : f < this._o3 && (f = this._h3 + d * this._n1) : this._z || (0 >= this.currSlideId && 0 < g - this._d3 && (f = this._h3 + d * this._n1), 
                this.currSlideId >= this.numSlides - 1 && 0 > g - this._d3 && (f = this._h3 + d * this._n1));
                this._h3 = f;
                200 < c - this._j3 && (this._j3 = c, this._v = g);
                b ? this._q3(this._h3) : this._l && this._p3(this._h3);
            }
        },
        _x2: function(a, b) {
            var c = this, d, e = "touchmove" === a.type;
            if (!c._s2 || e) {
                if (e) {
                    if (c._r3) return;
                ...
                } else d = a, c.msEnabled && (d = d.originalEvent);
                c._a3 || (c._e && (!b ? c._p1 : c._s3).css(c._g + c._u1, "0s"), function g() {
                    c._l2 && (c._t3 = requestAnimationFrame(g), c._u3 && c._k3(c._u3, b));
                }());
                if (c._l3) a.preventDefault(), c._m3 = new Date().getTime(), c._u3 = d; else if (f = !b ? c._h : c._e3, 
                d = Math.abs(d.pageX - c._b3) - Math.abs(d.pageY - c._c3) - (f ? -7 : 7), 7 < d) {
                    if (f) a.preventDefault(), c._z2 = "x"; else if (e) {
                        c._v3();
                        return;
                    }
                    c._l3 = !0;
        ...
        _y2: function(b, c) {
            ...
            function e(a, b) {
                if (f._l || c) i = (-f._u - f._d1) * f._w, j = Math.abs(f._p - i), f._c = j / b, 
                a && (f._c += 250), f._c = d(f._c), f._x3(i, !1);
            }
            var f = this, g, h, i, j;
            h = "touchend" === b.type || "touchcancel" === b.type;
            if (!f._s2 || h) if (f._s2 = !1, f.ev.trigger("rsDragRelease"), f._u3 = null, f._l2 = !1, 
            f._r3 = !1, f._l3 = !1, f._m3 = 0, cancelAnimationFrame(f._t3), f._a3 && (c ? f._q3(f._h3) : f._l && f._p3(f._h3)), 
            f._b.off(f._k1).off(f._l1), h && f._e1.off(f._m1), f._i1(), !f._a3 && !f._v2 && c && f._w3) {
                var k = a(b.target).closest(".rsNavItem");
                k.length && f.goTo(k.index());
            } else {
                g = !c ? f._h : f._e3;
                if (!f._a3 || "y" === f._z2 && g || "x" === f._z2 && !g) if (!c && f._t2) {
                    f._t2 = !1;
                    if (f.st.navigateByClick) {
                        f._i2(f.msEnabled ? b.originalEvent : b);
                        f.dragSuccess = !0;
                        return;
                    }
                    f.dragSuccess = !0;
                    ...
                    f.dragSuccess = !1;
                    return;
                } else f.dragSuccess = !0;
                f._t2 = !1;
                f._z2 = "";
                var l = f.st.minSlideOffset;
                h = h ? b.originalEvent.changedTouches[0] : f.msEnabled ? b.originalEvent : b;
                var m = g ? h.pageX : h.pageY, n = f._d3;
                h = f._v;
                var o = f.currSlideId, p = f.numSlides, q = g ? f._f3 : f._g3, r = f._z;
                Math.abs(m - n);
                g = m - h;
                h = new Date().getTime() - f._j3;
                h = Math.abs(g) / h;
                if (0 === q || 1 >= p) e(!0, h); else {
                    if (!r && !c) if (0 >= o) {
                        if (0 < q) {
                            e(!0, h);
                            return;
                    ...
                    if (c) {
                        i = f._i3;
                        if (i > f._n3) i = f._n3; else if (i < f._o3) i = f._o3; else {
                            l = h * h / .006;
                            k = -f._i3;
                            m = f._y3 - f._z3 + f._i3;
                            0 < g && l > k ? (k += f._z3 / (15 / (.003 * (l / h))), h = h * k / l, l = k) : 0 > g && l > m && (m += f._z3 / (15 / (.003 * (l / h))), 
                            h = h * m / l, l = m);
                            k = Math.max(Math.round(h / .003), 50);
                            i += l * (0 > g ? -1 : 1);
                            if (i > f._n3) {
                                f._a4(i, k, !0, f._n3, 200);
                                return;
                            }
                            if (i < f._o3) {
                                f._a4(i, k, !0, f._o3, 200);
                                return;
                            }
                        }
                        f._a4(i, k, !0);
                    } else n + l < m ? 0 > q ? e(!1, h) : f._m2("prev", d(Math.abs(f._p - (-f._u - f._d1 + 1) * f._w) / h), !1, !0, !0) : n - l > m ? 0 < q ? e(!1, h) : f._m2("next", d(Math.abs(f._p - (-f._u - f._d1 - 1) * f._w) / h), !1, !0, !0) : e(!1, h);
                }
            }
        },
        _p3: function(a) {
            a = this._p = a;
            this._e ? this._p1.css(this._x1, this._y1 + (this._h ? a + this._z1 + 0 : 0 + this._z1 + a) + this._a2) : this._p1.css(this._h ? this._x1 : this._w1, a);
        },
        updateSliderSize: function(a) {
            var b, c;
            if (this.st.autoScaleSlider) {
                var d = this.st.autoScaleSliderWidth, e = this.st.autoScaleSliderHeight;
                this.st.autoScaleHeight ? (b = this.slider.width(), b != this.width && (this.slider.css("height", b * (e / d)), 
                b = this.slider.width()), c = this.slider.height()) : (c = this.slider.height(), 
                c != this.height && (this.slider.css("width", c * (d / e)), c = this.slider.height()), 
                b = this.slider.width());
            ...
            if (a || b != this.width || c != this.height) {
                ...
                for (b = 0; b < this.slides.length; b++) a = this.slides[b], a.positionSet = !1, 
                a && (a.images && a.isLoaded) && (a.isRendered = !1, this._q2(a));
        ...
        appendSlide: function(a, b) {
            var c = this._s(a);
            if (isNaN(b) || b > this.numSlides) b = this.numSlides;
            this.slides.splice(b, 0, c);
            this.slidesJQ.splice(b, 0, '<div style="' + (this._l ? "position:absolute;" : this._n) + '" class="rsSlide"></div>');
            b < this.currSlideId && this.currSlideId++;
            this.ev.trigger("rsOnAppendSlide", [ c, b ]);
            this._f4(b);
            b === this.currSlideId && this.ev.trigger("rsAfterSlideChange");
        },
        removeSlide: function(a) {
            var b = this.slides[a];
            b && (b.holder && b.holder.remove(), a < this.currSlideId && this.currSlideId--, 
            this.slides.splice(a, 1), this.slidesJQ.splice(a, 1), this.ev.trigger("rsOnRemoveSlide", [ a ]), 
            this._f4(a), a === this.currSlideId && this.ev.trigger("rsAfterSlideChange"));
        },
        _f4: function() {
            var a = this, b = a.numSlides, b = 0 >= a._u ? 0 : Math.floor(a._u / b);
            a.numSlides = a.slides.length;
            0 === a.numSlides ? (a.currSlideId = a._d1 = a._u = 0, a.currSlide = a._g4 = null) : a._u = b * a.numSlides + a.currSlideId;
            for (b = 0; b < a.numSlides; b++) a.slides[b].id = b;
            a.currSlide = a.slides[a.currSlideId];
            a._r1 = a.slidesJQ[a.currSlideId];
            a.currSlideId >= a.numSlides ? a.goTo(a.numSlides - 1) : 0 > a.currSlideId && a.goTo(0);
            a._t();
            a._l && a._z && a._p1.css(a._g + a._u1, "0ms");
            a._h4 && clearTimeout(a._h4);
            a._h4 = setTimeout(function() {
                a._l && a._p3((-a._u - a._d1) * a._w);
                a._n2();
                a._l || a._r1.css({
                    display: "block",
                    opacity: 1
        ...
        _m2: function(a, b, c, d, e) {
            ...
            i = "next" === a ? f.currSlideId + 1 : "prev" === a ? f.currSlideId - 1 : a = parseInt(a, 10);
            if (!f._z) {
                if (0 > i) {
                    f._i4("left", !d);
                    return;
            ...
            f._r2 && (f._u2(!0), c = !1);
            h = i - f.currSlideId;
            i = f._o2 = f.currSlideId;
            var j = f.currSlideId + h;
            d = f._u;
            var k;
            f._z ? (j = f._n2(!1, j), d += h) : d = j;
            f._o = j;
            ...
            f.currSlide = f.slides[f.currSlideId];
            f._r1 = f.slidesJQ[f.currSlideId];
            var j = f.st.slidesDiff, l = Boolean(0 < h);
            h = Math.abs(h);
            var m = Math.floor(i / f._y), n = Math.floor((i + (l ? j : -j)) / f._y), m = (l ? Math.max(m, n) : Math.min(m, n)) * f._y + (l ? f._y - 1 : 0);
            m > f.numSlides - 1 ? m = f.numSlides - 1 : 0 > m && (m = 0);
            i = l ? m - i : i - m;
            i > f._y && (i = f._y);
            if (h > i + j) {
                f._d1 += (h - (i + j)) * (l ? -1 : 1);
                b *= 1.4;
                for (i = 0; i < f.numSlides; i++) f.slides[i].positionSet = !1;
            }
            f._c = b;
            f._n2(!0);
            e || (k = !0);
            ...
            }, 0) : (f._x3(g, a, !1, c), f.ev.trigger("rsOnUpdateNav"));
        },
        _f2: function() {
        ...
        _x3: function(b, c, d, e, f) {
            function g() {
                var a;
                if (i && (a = i.data("rsTimeout"))) i !== j && i.css({
                    opacity: 0,
                    display: "none",
                    zIndex: 0
                }), clearTimeout(a), i.data("rsTimeout", "");
                if (a = j.data("rsTimeout")) clearTimeout(a), j.data("rsTimeout", "");
            }
            var h = this, i, j, k = {};
            isNaN(h._c) && (h._c = 400);
            h._p = h._h3 = b;
            h.ev.trigger("rsBeforeAnimStart");
            h._e ? h._l ? (h._c = parseInt(h._c, 10), d = h._g + h._v1, k[h._g + h._u1] = h._c + "ms", 
            k[d] = e ? a.rsCSS3Easing[h.st.easeInOut] : a.rsCSS3Easing[h.st.easeOut], h._p1.css(k), 
            e || !h.hasTouch ? setTimeout(function() {
                h._p3(b);
            }, 5) : h._p3(b)) : (h._c = h.st.transitionSpeed, i = h._g4, j = h._r1, j.data("rsTimeout") && j.css("opacity", 0), 
            g(), i && i.data("rsTimeout", setTimeout(function() {
                k[h._g + h._u1] = "0ms";
                k.zIndex = 0;
                k.display = "none";
                i.data("rsTimeout", "");
            ...
            }, h._c + 60)), k.display = "block", k.zIndex = h._m, k.opacity = 0, k[h._g + h._u1] = "0ms", 
            k[h._g + h._v1] = a.rsCSS3Easing[h.st.easeInOut], j.css(k), j.data("rsTimeout", setTimeout(function() {
                j.css(h._g + h._u1, h._c + "ms");
                j.data("rsTimeout", setTimeout(function() {
                    j.css("opacity", 1);
                    j.data("rsTimeout", "");
                }, 20));
            }, 20))) : h._l ? (k[h._h ? h._x1 : h._w1] = b + "px", h._p1.animate(k, h._c, e ? h.st.easeInOut : h.st.easeOut)) : (i = h._g4, 
            j = h._r1, j.stop(!0, !0).css({
                opacity: 0,
                display: "block",
                zIndex: h._m
            }), h._c = h.st.transitionSpeed, j.animate({
                opacity: 1
            }, h._c, h.st.easeInOut), g(), i && i.data("rsTimeout", setTimeout(function() {
                i.stop(!0, !0).css({
                    opacity: 0,
                    display: "none",
                    zIndex: 0
            ...
            h.loadingTimeout = f ? setTimeout(function() {
                h.loadingTimeout = null;
                f.call();
        ...
        _l4: function() {
            var a = window.getComputedStyle(this._p1.get(0), null).getPropertyValue(this._g + "transform").replace(/^matrix\(/i, "").split(/, |\)$/g), b = 0 === a[0].indexOf("matrix3d");
        ...
        _i4: function(a, b) {
            var c = this, d = (-c._u - c._d1) * c._w;
            if (!(0 === c.numSlides || c._r2)) if (c.st.loopRewind) c.goTo("left" === a ? c.numSlides - 1 : 0, b); else if (c._l) {
                c._c = 200;
                var e = function() {
                    c._r2 = !1;
                };
        ...
        _q2: function(a) {
            if (!a.isRendered) {
                var b = a.content, c = "rsMainSlideImage", d, e = this.st.imageAlignCenter, f = this.st.imageScaleMode, g;
                a.videoURL && (c = "rsVideoContainer", "fill" !== f ? d = !0 : (g = b, g.hasClass(c) || (g = g.find("." + c)), 
                g.css({
                    width: "100%",
                    height: "100%"
                }), c = "rsMainSlideImage"));
                b.hasClass(c) || (b = b.find("." + c));
                if (b) {
                    var h = a.iW, c = a.iH;
                    a.isRendered = !0;
                    if ("none" !== f || e) {
                        a = "fill" !== f ? this._d4 : 0;
                        g = this._b4 - 2 * a;
                        var i = this._c4 - 2 * a, j, k, l = {};
                        if ("fit-if-smaller" === f && (h > g || c > i)) f = "fit";
                        if ("fill" === f || "fit" === f) j = g / h, k = i / c, j = "fill" == f ? j > k ? j : k : "fit" == f ? j < k ? j : k : 1, 
                        h = Math.ceil(h * j, 10), c = Math.ceil(c * j, 10);
                        "none" !== f && (l.width = h, l.height = c, d && b.find(".rsImg").css({
                            width: "100%",
                            height: "100%"
                        }));
                        e && (l.marginLeft = Math.floor((g - h) / 2) + a, l.marginTop = Math.floor((i - c) / 2) + a);
                        b.css(l);
                    }
                }
            }
    ...
    a.fn.royalSlider = function(c) {
        ...
        return this.each(function() {
            var e = a(this);
            if ("object" === typeof c || !c) e.data("royalSlider") || e.data("royalSlider", new b(e, c)); else if ((e = e.data("royalSlider")) && e[c]) return e[c].apply(e, Array.prototype.slice.call(d, 1));
        });
    };
...
(function(a) {
    a.rsProto._o4 = function() {
        var a, b = this;
        if (b.st.addActiveClass) b.ev.on("rsOnUpdateNav", function() {
            a && clearTimeout(a);
            a = setTimeout(function() {
                b._g4 && b._g4.removeClass("rsActiveSlide");
                b._r1 && b._r1.addClass("rsActiveSlide");
                a = null;
            }, 50);
        });
    };
...
(function(a) {
    a.extend(a.rsProto, {
        _p4: function() {
            function b() {
                var a = c.currSlide;
                if (c.currSlide && c.currSlide.isLoaded && c._t4 !== a) {
                    if (0 < c._s4.length) {
                        for (d = 0; d < c._s4.length; d++) clearTimeout(c._s4[d]);
                        c._s4 = [];
                    }
                    if (0 < c._r4.length) {
                        var b;
                        for (d = 0; d < c._r4.length; d++) if (b = c._r4[d]) c._e ? (b.block.css(c._g + c._u1, "0s"), 
                        b.block.css(b.css)) : b.block.stop(!0).css(b.css), c._t4 = null, a.animBlocksDisplayed = !1;
                        c._r4 = [];
                    }
                    a.animBlocks && (a.animBlocksDisplayed = !0, c._t4 = a, c._u4(a.animBlocks));
                }
            }
            var c = this, d;
            c._q4 = {
            ...
            c.ev.on("rsBeforeParseNode", function(b, c, d) {
                c = a(c);
                d.animBlocks = c.find(".rsABlock").css("display", "none");
                d.animBlocks.length || (d.animBlocks = c.hasClass("rsABlock") ? c.css("display", "none") : !1);
            });
            c.ev.on("rsAfterContentSet", function(a, d) {
                d.id === c.slides[c.currSlideId].id && setTimeout(function() {
                    b();
        ...
        _u4: function(b) {
            ...
            b.each(function(b) {
                ...
                f = {};
                g = null;
                var k = d.attr("data-move-offset"), k = k ? parseInt(k, 10) : c.st.block.moveOffset;
                if (0 < k && ((i = d.data("move-effect")) ? (i = i.toLowerCase(), "none" === i ? i = !1 : "left" !== i && ("top" !== i && "bottom" !== i && "right" !== i) && (i = c.st.block.moveEffect, 
                "none" === i && (i = !1))) : i = c.st.block.moveEffect, i && "none" !== i)) {
                    var l;
                    l = "right" === i || "left" === i ? !0 : !1;
                    var m;
                    j = !1;
                    c._e ? (m = 0, h = c._x1) : (l ? isNaN(parseInt(d.css("right"), 10)) ? h = "left" : (h = "right", 
                    j = !0) : isNaN(parseInt(d.css("bottom"), 10)) ? h = "top" : (h = "bottom", j = !0), 
                    h = "margin-" + h, j && (k = -k), c._e ? m = parseInt(d.css(h), 10) : (m = d.data("rs-start-move-prop"), 
                    void 0 === m && (m = parseInt(d.css(h), 10), d.data("rs-start-move-prop", m))));
                    f[h] = c._m4("top" === i || "left" === i ? m - k : m + k, l);
                    e[h] = c._m4(m, l);
                }
                if (k = d.attr("data-fade-effect")) {
                    if ("none" === k.toLowerCase() || "false" === k.toLowerCase()) k = !1;
                } else k = c.st.block.fadeEffect;
                k && (f.opacity = 0, e.opacity = 1);
                if (k || i) g = {}, g.hasFade = Boolean(k), Boolean(i) && (g.moveProp = h, g.hasMove = !0), 
                g.speed = d.data("speed"), isNaN(g.speed) && (g.speed = c.st.block.speed), g.easing = d.data("easing"), 
                g.easing || (g.easing = c.st.block.easing), g.css3Easing = a.rsCSS3Easing[g.easing], 
                g.delay = d.data("delay"), isNaN(g.delay) && (g.delay = c.st.block.delay * b);
                k = {};
                c._e && (k[c._g + c._u1] = "0ms");
                k.moveProp = e.moveProp;
                k.opacity = e.opacity;
                k.display = "none";
                c._r4.push({
                    block: d,
                ...
                c._v4(d, f);
                c._s4.push(setTimeout(function(a, b, d, e) {
                    return function() {
                        a.css("display", "block");
                        if (d) {
                            var f = {};
                            if (c._e) {
                                var g = "";
                                d.hasMove && (g += d.moveProp);
                                d.hasFade && (d.hasMove && (g += ", "), g += "opacity");
                                f[c._g + c._t1] = g;
                                f[c._g + c._u1] = d.speed + "ms";
                                f[c._g + c._v1] = d.css3Easing;
                                a.css(f);
                                setTimeout(function() {
                                    a.css(b);
                                }, 24);
                            } else setTimeout(function() {
                                a.animate(b, d.speed, d.easing);
                            }, 16);
                        }
                        delete c._s4[e];
                    };
                }(d, e, g, b), 6 >= g.delay ? 12 : g.delay));
            });
        }
    });
...
(function(a) {
    a.extend(a.rsProto, {
        _w4: function() {
            var a = this;
            if (a.st.autoHeight) {
                var b, c, d, e = function(e) {
                    d = a.slides[a.currSlideId];
                    if (b = d.holder) if ((c = b.height()) && void 0 !== c) a._c4 = c, a._e || !e ? a._e1.css("height", c) : a._e1.stop(!0, !0).animate({
                        height: c
...
(function(a) {
    a.extend(a.rsProto, {
        _x4: function() {
            ...
            b.st.autoPlay.enabled && (b.ev.on("rsBeforeParseNode", function(b, d, e) {
                d = a(d);
                if (c = d.attr("data-rsDelay")) e.customDelay = parseInt(c, 10);
    ...
    a.extend(a.rsProto, {
        _i5: function() {
            ...
            "bullets" === b.st.controlNavigation && (b.ev.one("rsAfterPropsSetup", function() {
                ...
                b._k5.on("click.rs", ".rsNavItem", function() {
                    b._m5 || b.goTo(a(this).index());
                });
            }), b.ev.on("rsOnAppendSlide", function(a, c, d) {
                d >= b.numSlides ? b._k5.append('<div class="rsNavItem rsBullet"><span></span></div>') : b._l5.eq(d).before('<div class="rsNavItem rsBullet"><span></span></div>');
    ...
    a.extend(a.rsProto, {
        _o5: function() {
            ...
            if (b.st.deeplinking.enabled) {
                var f = b.st.deeplinking.change, g = "#" + b.st.deeplinking.prefix, h = function() {
                    var a = window.location.hash;
                    return a && (a = parseInt(a.substring(g.length), 10), 0 <= a) ? a - 1 : -1;
                }, i = h();
                -1 !== i && (b.st.startSlideId = i);
                f && (a(window).on("hashchange" + b.ns, function() {
                    if (!c) {
                        var a = h();
                    ...
                    e = setTimeout(function() {
                        c = !0;
                        window.location.replace(("" + window.location).split("#")[0] + g + (b.currSlideId + 1));
                ...
                b.ev.on("rsBeforeDestroy", function() {
                    d = e = null;
                    f && a(window).off("hashchange" + b.ns);
                });
            }
        }
    });
...
(function(a, b, c) {
    ...
    "$:nomunge";
    var e = document, f, g = a.event.special, h = e.documentMode, i = "onhashchange" in b && (h === c || 7 < h);
    ...
    var j = function() {
        var c = d(), e = n(l);
        c !== l ? (m(l = c, e), a(b).trigger("hashchange")) : e !== l && (location.href = location.href.replace(/#.*/, "") + e);
        k = setTimeout(j, a.fn.hashchange.delay);
    }, g = {}, k, l = d(), m = h = function(a) {
        return a;
    }, n = h;
    g.start = function() {
        k || j();
    ...
    if (b.attachEvent && !b.addEventListener && !i) {
        var o, p;
        g.start = function() {
            o || (p = (p = a.fn.hashchange.src) && p + d(), o = a('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                p || m(d());
                j();
            }).attr("src", p || "javascript:0").insertAfter("body")[0].contentWindow, e.onpropertychange = function() {
                try {
                    "title" === event.propertyName && (o.document.title = e.title);
                } catch (a) {}
            });
        };
        g.stop = h;
        ...
        m = function(b, c) {
            var d = o.document, f = a.fn.hashchange.domain;
            b !== c && (d.title = e.title, d.open(), f && d.write('<script>document.domain="' + f + '"</script>'), 
            d.close(), o.location.hash = b);
        };
    }
    f = g;
})(jQuery, this);
...
(function(a) {
    a.extend(a.rsProto, {
        _q5: function() {
            ...
            if (b.st.fullscreen.enabled) b.ev.one("rsBeforeSizeSet", function() {
                b._s5();
            });
        },
        _s5: function() {
            var b = this;
            b._t5 = !b.st.keyboardNavEnabled && b.st.fullscreen.keyboardNav;
            if (b.st.fullscreen.nativeFS) {
                b._u5 = {
                ...
                if (!b.isAndroid) if ("undefined" != typeof document.cancelFullScreen) b._u5.supportsFullScreen = !0; else for (var d = 0; d < c.length; d++) if (b._u5.prefix = c[d], 
                "undefined" != typeof document[b._u5.prefix + "CancelFullScreen"]) {
                    b._u5.supportsFullScreen = !0;
                    break;
                }
                b._u5.supportsFullScreen ? (b.nativeFS = !0, b._u5.fullScreenEventName = b._u5.prefix + "fullscreenchange" + b.ns, 
                b._u5.isFullScreen = function() {
                    switch (this.prefix) {
                      case "":
        ...
        enterFullscreen: function(b) {
            var c = this;
            if (c._u5) if (b) c._u5.requestFullScreen(a("html")[0]); else {
                c._b.on(c._u5.fullScreenEventName, function() {
            ...
            if (!c._w5) {
                c._w5 = !0;
                c._b.on("keyup" + c.ns + "fullscreen", function(a) {
                ...
                var d;
                for (d = 0; d < c.numSlides; d++) b = c.slides[d], b.isRendered = !1, b.bigImage && (b.isBig = !0, 
                b.isMedLoaded = b.isLoaded, b.isMedLoading = b.isLoading, b.medImage = b.image, 
                b.medIW = b.iW, b.medIH = b.iH, b.slideId = -99, b.bigImage !== b.medImage && (b.sizeType = "big"), 
                b.isLoaded = b.isBigLoaded, b.isLoading = !1, b.image = b.bigImage, b.images[0] = b.bigImage, 
        ...
        exitFullscreen: function(b) {
            ...
            if (!c._w5) {
                ...
                var d;
                for (d = 0; d < c.numSlides; d++) b = c.slides[d], b.isRendered = !1, b.bigImage && (b.isBig = !1, 
                b.slideId = -99, b.isBigLoaded = b.isLoaded, b.isBigLoading = b.isLoading, b.bigImage = b.image, 
                b.bigIW = b.iW, b.bigIH = b.iH, b.isLoaded = b.isMedLoaded, b.isLoading = !1, b.image = b.medImage, 
                b.images[0] = b.medImage, b.iW = b.medIW, b.iH = b.medIH, b.isAppended = b.contentAdded = !1, 
                c._c6(b, !0), b.bigImage !== b.medImage && (b.sizeType = "med"));
                c.isFullscreen = !1;
                b = a(window);
                b.scrollTop(c._x5);
                b.scrollLeft(c._y5);
        ...
        _c6: function(b) {
            var c = !b.isLoaded && !b.isLoading ? '<a class="rsImg rsMainSlideImage" href="' + b.image + '"></a>' : '<img class="rsImg rsMainSlideImage" src="' + b.image + '"/>';
            b.content.hasClass("rsImg") ? b.content = a(c) : b.content.find(".rsImg").eq(0).replaceWith(c);
            !b.isLoaded && (!b.isLoading && b.holder) && b.holder.html(b.content);
        }
    });
    ...
    a.extend(a.rsProto, {
        _d6: function() {
            ...
            b.st.globalCaption && (b.ev.on("rsAfterInit", function() {
                b.globalCaption = a('<div class="rsGCaption"></div>').appendTo(!b.st.globalCaptionInside ? b.slider : b._e1);
    ...
    a.extend(a.rsProto, {
        _f6: function() {
            ...
            "tabs" === b.st.controlNavigation && (b.ev.on("rsBeforeParseNode", function(b, c, d) {
                ...
                d.thumbnail.length ? d.thumbnail = a(document.createElement("div")).append(d.thumbnail).html() : (d.thumbnail = c.attr("data-rsTmb"), 
                d.thumbnail || (d.thumbnail = c.find(".rsImg").attr("data-rsTmb")), d.thumbnail = d.thumbnail ? '<img src="' + d.thumbnail + '"/>' : "");
        ...
        _g6: function() {
            ...
            for (var d = 0; d < b.numSlides; d++) c += '<div class="rsNavItem rsTab">' + b.slides[d].thumbnail + "</div>";
            c = a(c + "</div>");
            b._k5 = c;
            b._l5 = c.children(".rsNavItem");
            b.slider.append(c);
    ...
    a.extend(a.rsProto, {
        _h6: function() {
            ...
            "thumbnails" === b.st.controlNavigation && (b._i6 = {
                ...
                paddingTop: 0,
                paddingBottom: 0
            }, b.st.thumbs = a.extend({}, b._i6, b.st.thumbs), b._j6 = !0, !1 === b.st.thumbs.firstMargin ? b.st.thumbs.firstMargin = 0 : !0 === b.st.thumbs.firstMargin && (b.st.thumbs.firstMargin = b.st.thumbs.spacing), 
            b.ev.on("rsBeforeParseNode", function(b, c, d) {
                c = a(c);
                d.thumbnail = c.find(".rsTmb").remove();
                d.thumbnail.length ? d.thumbnail = a(document.createElement("div")).append(d.thumbnail).html() : (d.thumbnail = c.attr("data-rsTmb"), 
                d.thumbnail || (d.thumbnail = c.find(".rsImg").attr("data-rsTmb")), d.thumbnail = d.thumbnail ? '<img src="' + d.thumbnail + '"/>' : "");
                ...
                c !== b._n5 && (b._n5 && (b._n5.removeClass("rsNavSelected"), b._n5 = null), b._l6 && b._m6(b.currSlideId), 
                b._n5 = c.addClass("rsNavSelected"));
            }), b.ev.on("rsOnAppendSlide", function(a, c, d) {
                a = "<div" + b._n6 + ' class="rsNavItem rsThumb">' + b._o6 + c.thumbnail + "</div>";
                d >= b.numSlides ? b._s3.append(a) : b._l5.eq(d).before(a);
        ...
        _k6: function() {
            var b = this, c = "rsThumbs", d = b.st.thumbs, e = "", f, g, h = d.spacing;
            b._j5 = !0;
            b._e3 = "vertical" === d.orientation ? !1 : !0;
            b._n6 = f = h ? ' style="margin-' + (b._e3 ? "right" : "bottom") + ":" + h + 'px;"' : "";
            b._i3 = 0;
            b._p6 = !1;
            b._m5 = !1;
            b._l6 = !1;
            b._q6 = d.arrows && d.navigation;
            g = b._e3 ? "Hor" : "Ver";
            b.slider.addClass("rsWithThumbs rsWithThumbs" + g);
            e += '<div class="rsNav rsThumbs rsThumbs' + g + '"><div class="' + c + 'Container">';
            b._o6 = d.appendSpan ? '<span class="thumbIco"></span>' : "";
            for (var i = 0; i < b.numSlides; i++) g = b.slides[i], e += "<div" + f + ' class="rsNavItem rsThumb">' + g.thumbnail + b._o6 + "</div>";
            e = a(e + "</div></div>");
            f = {};
            d.paddingTop && (f[b._e3 ? "paddingTop" : "paddingLeft"] = d.paddingTop);
            d.paddingBottom && (f[b._e3 ? "paddingBottom" : "paddingRight"] = d.paddingBottom);
            e.css(f);
            b._s3 = a(e).find("." + c + "Container");
            b._q6 && (c += "Arrow", d.arrowLeft ? b._r6 = d.arrowLeft : (b._r6 = a('<div class="' + c + " " + c + 'Left"><div class="' + c + 'Icn"></div></div>'), 
            e.append(b._r6)), d.arrowRight ? b._s6 = d.arrowRight : (b._s6 = a('<div class="' + c + " " + c + 'Right"><div class="' + c + 'Icn"></div></div>'), 
            e.append(b._s6)), b._r6.click(function() {
                var a = (Math.floor(b._i3 / b._t6) + b._u6) * b._t6;
                b._a4(a > b._n3 ? b._n3 : a);
            }), b._s6.click(function() {
                var a = (Math.floor(b._i3 / b._t6) - b._u6) * b._t6;
                b._a4(a < b._o3 ? b._o3 : a);
            }), d.arrowsAutoHide && !b.hasTouch && (b._r6.css("opacity", 0), b._s6.css("opacity", 0), 
            e.one("mousemove.rsarrowshover", function() {
                b._l6 && (b._r6.css("opacity", 1), b._s6.css("opacity", 1));
            }), e.hover(function() {
                b._l6 && (b._r6.css("opacity", 1), b._s6.css("opacity", 1));
            }, function() {
                b._l6 && (b._r6.css("opacity", 0), b._s6.css("opacity", 0));
            })));
            b._k5 = e;
            b._l5 = b._s3.children();
            b.msEnabled && b.st.thumbs.navigation && b._s3.css("-ms-touch-action", b._e3 ? "pan-y" : "pan-x");
            b.slider.append(e);
            b._w3 = !0;
            b._v6 = h;
            d.navigation && b._e && b._s3.css(b._g + "transition-property", b._g + "transform");
            b._k5.on("click.rs", ".rsNavItem", function() {
                b._m5 || b.goTo(a(this).index());
            });
            b.ev.off("rsBeforeSizeSet.thumbs").on("rsBeforeSizeSet.thumbs", function() {
                b._w6 = b._e3 ? b._c4 : b._b4;
                b.updateThumbsSize(!0);
            });
        },
        updateThumbsSize: function() {
            var a = this, b = a._l5.first(), c = {}, d = a._l5.length;
            a._t6 = (a._e3 ? b.outerWidth() : b.outerHeight()) + a._v6;
            a._y3 = d * a._t6 - a._v6;
        ...
        setThumbsOrientation: function(a, b) {
            ...
            this._k6(), this._k5.off(this._j1), b || this.updateSliderSize(!0));
        },
        _q3: function(a) {
            this._i3 = a;
        ...
        _a4: function(b, c, d, e, f) {
            var g = this;
            if (g._l6) {
                c || (c = g.st.thumbs.transitionSpeed);
                g._i3 = b;
                g._x6 && clearTimeout(g._x6);
                g._p6 && (g._e || g._s3.stop(), d = !0);
                var h = {};
                g._p6 = !0;
                g._e ? (h[g._g + "transition-duration"] = c + "ms", h[g._g + "transition-timing-function"] = d ? a.rsCSS3Easing[g.st.easeOut] : a.rsCSS3Easing[g.st.easeInOut], 
                g._s3.css(h), g._q3(b)) : (h[g._e3 ? g._x1 : g._w1] = b + "px", g._s3.animate(h, c, d ? "easeOutCubic" : g.st.easeInOut));
                e && (g._i3 = e);
                g._y6();
                g._x6 = setTimeout(function() {
                    g._p6 = !1;
                    f && (g._a4(e, f, !0), f = null);
                }, c);
            }
        },
        _y6: function() {
        ...
        _m6: function(a, b) {
            var c = 0, d, e = a * this._t6 + 2 * this._t6 - this._v6 + this._n3, f = Math.floor(this._i3 / this._t6);
            this._l6 && (this._j6 && (b = !0, this._j6 = !1), e + this._i3 > this._z3 ? (a === this.numSlides - 1 && (c = 1), 
            f = -a + this._u6 - 2 + c, d = f * this._t6 + this._z3 % this._t6 + this._v6 - this._n3) : 0 !== a ? (a - 1) * this._t6 <= -this._i3 + this._n3 && a - 1 <= this.numSlides - this._u6 && (d = (-a + 1) * this._t6 + this._n3) : d = this._n3, 
            d !== this._i3 && (c = void 0 === d ? this._i3 : d, c > this._n3 ? this._q3(this._n3) : c < this._o3 ? this._q3(this._o3) : void 0 !== d && (b ? this._q3(d) : this._a4(d))), 
            this._y6());
        }
    });
    ...
    a.extend(a.rsProto, {
        _z6: function() {
            ...
            b.ev.on("rsBeforeSizeSet", function() {
                b._b7 && setTimeout(function() {
                    var a = b._r1, a = a.hasClass("rsVideoContainer") ? a : a.find(".rsVideoContainer");
                    b._c7 && b._c7.css({
                        width: a.width(),
                        height: a.height()
                    });
            ...
            b.ev.on("rsAfterParseNode", function(d, e, f) {
                ...
                if (f.videoURL) {
                    ...
                    e = a('<div class="rsVideoContainer"></div>');
        ...
        playVideo: function() {
            ...
            if (!b._b7) {
                ...
                var d = b._d7 = c.content, c = c.videoURL, e, f;
                c.match(/youtu\.be/i) || c.match(/youtube\.com/i) ? (f = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/, 
                (f = c.match(f)) && 11 == f[7].length && (e = f[7]), void 0 !== e && (b._c7 = b.st.video.youTubeCode.replace("%id%", e))) : c.match(/vimeo\.com/i) && (f = /(www\.)?vimeo.com\/(\d+)($|\/)/, 
                (f = c.match(f)) && (e = f[2]), void 0 !== e && (b._c7 = b.st.video.vimeoCode.replace("%id%", e)));
                b.videoObj = a(b._c7);
                b.ev.trigger("rsOnCreateVideoElement", [ c ]);
                b.videoObj.length && (b._c7 = a('<div class="rsVideoFrameHolder"><div class="rsPreloader"></div><div class="rsCloseVideoBtn"><div class="rsCloseVideoIcn"></div></div></div>'), 
                b._c7.find(".rsPreloader").after(b.videoObj), d = d.hasClass("rsVideoContainer") ? d : d.find(".rsVideoContainer"), 
                b._c7.css({
                    width: d.width(),
                    height: d.height()
                    ...
                    a.stopPropagation();
                    return !1;
                }), d.append(b._c7), b.isIPAD && d.addClass("rsIOSVideo"), b._e7(!1), setTimeout(function() {
                    b._c7.addClass("rsVideoActive");
                }, 10), b.ev.trigger("rsVideoPlay"), b._b7 = !0);
                return !0;
            }
            return !1;
        },
        ...
        _e7: function(a) {
            ...
            c.autoHideBlocks && this.currSlide.animBlocks && b.push(this.currSlide.animBlocks);
...
(function(a) {
    a.rsProto._f7 = function() {
        var b = this;
        b.st.visibleNearby && b.st.visibleNearby.enabled && (b._g7 = {
            enabled: !0,
            centerArea: .6,
            center: !0,
            breakpoint: 0,
        ...
        }, b.st.visibleNearby = a.extend({}, b._g7, b.st.visibleNearby), b.ev.one("rsAfterPropsSetup", function() {
            b._h7 = b._e1.css("overflow", "visible").wrap('<div class="rsVisibleNearbyWrap"></div>').parent();
            b.st.visibleNearby.hiddenOverflow || b._h7.css("overflow", "visible");
            b._o1 = b.st.controlsInside ? b._h7 : b.slider;
        }), b.ev.on("rsAfterSizePropSet", function() {
            var a, c = b.st.visibleNearby;
            a = c.breakpoint && b.width < c.breakpoint ? c.breakpointCenterArea : c.centerArea;
            b._h ? (b._b4 *= a, b._h7.css({
                height: b._c4,
                width: b._b4 / a
            }), b._d = b._b4 * (1 - a) / 2 / a) : (b._c4 *= a, b._h7.css({
                height: b._c4 / a,
                width: b._b4
            }), b._d = b._c4 * (1 - a) / 2 / a);
            c.navigateByCenterClick || (b._q = b._h ? b._b4 : b._c4);
            c.center && b._e1.css("margin-" + (b._h ? "left" : "top"), b._d);
        }));
    };
    a.rsModules.visibleNearby = a.rsProto._f7;
})(jQuery);
...
(function() {
    ...
    var j = a.jQuery, k = a.console, l = k !== void 0, m = Object.prototype.toString;
    ...
    var c = c || function(c) {
        var d = {
            ...
            eventType: function(a) {
                var b = {
                    down: g.hasTouch ? "touchstart" : "mousedown",
                    move: g.hasTouch ? "touchmove" : "mousemove",
                    up: g.hasTouch ? "touchend" : "mouseup",
                    out: g.hasTouch ? "touchcancel" : "mouseout"
                };
                return b[a];
            },
            page: function(a, b) {
                return g.hasTouch && b.touches.length && b.touches[0] ? b.touches[0]["page" + a] : b["page" + a];
            },
            klass: {
                has: function(a, b) {
                ...
                add: function(a, b) {
                    if (!g.klass.has(a, b) && d.addBodyClasses) {
                        a.className += " " + b;
                    }
                },
                remove: function(a, b) {
            ...
            vendor: function() {
                var a = b.createElement("div"), c = "webkit Moz O ms".split(" "), d;
                for (d in c) {
                    if (typeof a.style[c[d] + "Transition"] !== "undefined") {
                        return c[d];
                    }
                }
            },
            ...
            canTransform: function() {
                return typeof d.element.style[e.vendor + "Transform"] !== "undefined";
            },
            ...
            angleOfDrag: function(a, b) {
                var c, d;
                d = Math.atan2(-(e.startDragY - b), e.startDragX - a);
                if (d < 0) {
                    d += 2 * Math.PI;
                }
                c = Math.floor(d * (180 / Math.PI) - 180);
                if (c < 0 && c > -180) {
                    c = 360 - Math.abs(c);
                }
                return Math.abs(c);
            ...
            parentUntil: function(a, b) {
                ...
                while (a.parentNode) {
                    if (c && a.getAttribute && a.getAttribute(b)) {
                        return a;
                    } else {
                        if (!c && a === b) {
                            return a;
            ...
            translate: {
                get: {
                    matrix: function(b) {
                        if (!g.canTransform()) {
                            return parseInt(d.element.style.left, 10);
                        } else {
                            var c = a.getComputedStyle(d.element)[e.vendor + "Transform"].match(/\((.*)\)/), f = 8;
                            if (c) {
                                c = c[1].split(",");
                                if (c.length === 16) {
                                    b += f;
                ...
                easeCallback: function() {
                    d.element.style[e.vendor + "Transition"] = "";
                    e.translation = h.translate.get.matrix(4);
                    e.easing = false;
                    clearInterval(e.animatingInterval);
                    if (e.easingTo === 0) {
                        g.klass.remove(b.body, "snapjs-right");
                        g.klass.remove(b.body, "snapjs-left");
                    }
                    g.dispatchEvent("animated");
                    g.events.removeEvent(d.element, g.transitionCallback(), h.translate.easeCallback);
                },
                easeTo: function(a) {
                    if (!g.canTransform()) {
                        e.translation = a;
                        ...
                        e.easing = true;
                        e.easingTo = a;
                        d.element.style[e.vendor + "Transition"] = "all " + d.transitionSpeed + "s " + d.easing;
                        e.animatingInterval = setInterval(function() {
                            g.dispatchEvent("animating");
                        }, 1);
                        g.events.addEvent(d.element, g.transitionCallback(), h.translate.easeCallback);
                        h.translate.x(a);
                    }
                    if (a === 0) {
                        d.element.style[e.vendor + "Transform"] = "";
                    }
                },
                x: function(c) {
                    if (d.disable === "left" && c > 0 || d.disable === "right" && c < 0) {
                        return;
                    }
                    if (!d.hyperextensible) {
                        if (c === d.maxPosition || c > d.maxPosition) {
                            c = d.maxPosition;
                        } else {
                            if (c === d.minPosition || c < d.minPosition) {
                                c = d.minPosition;
                            }
                        }
                    }
                    ...
                    if (g.canTransform()) {
                        var f = "translate3d(" + c + "px, 0,0)";
                        d.element.style[e.vendor + "Transform"] = f;
                    } else {
                        d.element.style.width = (a.innerWidth || b.documentElement.clientWidth) + "px";
                        d.element.style.left = c + "px";
            ...
            drag: {
                listen: function() {
                    e.translation = 0;
                    e.easing = false;
                    g.events.addEvent(d.element, g.eventType("down"), h.drag.startDrag);
                    g.events.addEvent(d.element, g.eventType("move"), h.drag.dragging);
                    g.events.addEvent(d.element, g.eventType("up"), h.drag.endDrag);
                },
                stopListening: function() {
                    g.events.removeEvent(d.element, g.eventType("down"), h.drag.startDrag);
                    g.events.removeEvent(d.element, g.eventType("move"), h.drag.dragging);
                    g.events.removeEvent(d.element, g.eventType("up"), h.drag.endDrag);
                },
                startDrag: function(a) {
                    var b = a.target ? a.target : a.srcElement, c = g.parentUntil(b, "data-snap-ignore");
                    if (c) {
                        g.dispatchEvent("ignore");
                        return;
                    }
                    if (d.dragger) {
                        var f = g.parentUntil(b, d.dragger);
                        if (!f && (e.translation !== d.minPosition && e.translation !== d.maxPosition)) {
                            return;
                        }
                    }
                    g.dispatchEvent("start");
                    d.element.style[e.vendor + "Transition"] = "";
                    e.isDragging = true;
                    e.hasIntent = null;
                    e.intentChecked = false;
                    e.startDragX = g.page("X", a);
                    e.startDragY = g.page("Y", a);
                    e.dragWatchers = {
                        current: 0,
                        last: 0,
                        hold: 0,
                ...
                dragging: function(a) {
                    if (e.isDragging && d.touchToDrag) {
                        var c = g.page("X", a), f = g.page("Y", a), i = e.translation, j = h.translate.get.matrix(4), k = c - e.startDragX, l = j > 0, m = k, n;
                        if (e.intentChecked && !e.hasIntent) {
                            return;
                        }
                        if (d.addBodyClasses) {
                            if (j > 0) {
                                g.klass.add(b.body, "snapjs-left");
                                g.klass.remove(b.body, "snapjs-right");
                            } else {
                                if (j < 0) {
                                    g.klass.add(b.body, "snapjs-right");
                                    g.klass.remove(b.body, "snapjs-left");
                                }
                            }
                        }
                        if (e.hasIntent === false || e.hasIntent === null) {
                            var o = g.angleOfDrag(c, f), p = o >= 0 && o <= d.slideIntent || o <= 360 && o > 360 - d.slideIntent, q = o >= 180 && o <= 180 + d.slideIntent || o <= 180 && o >= 180 - d.slideIntent;
                            if (!q && !p) {
                                e.hasIntent = false;
                            } else {
                                e.hasIntent = true;
                        ...
                        if (d.minDragDistance >= Math.abs(c - e.startDragX) || e.hasIntent === false) {
                            return;
                        }
                        g.events.prevent(a);
                        g.dispatchEvent("drag");
                        e.dragWatchers.current = c;
                        if (e.dragWatchers.last > c) {
                            if (e.dragWatchers.state !== "left") {
                                e.dragWatchers.state = "left";
                                e.dragWatchers.hold = c;
                            }
                            e.dragWatchers.last = c;
                        } else {
                            if (e.dragWatchers.last < c) {
                        ...
                        if (l) {
                            if (d.maxPosition < j) {
                                n = (j - d.maxPosition) * d.resistance;
                                m = k - n;
                            }
                            e.simpleStates = {
                                opening: "left",
                                towards: e.dragWatchers.state,
                                hyperExtending: d.maxPosition < j,
                                halfway: j > d.maxPosition / 2,
                                flick: Math.abs(e.dragWatchers.current - e.dragWatchers.hold) > d.flickThreshold,
                                translation: {
                                    absolute: j,
                                    relative: k,
                                    sinceDirectionChange: e.dragWatchers.current - e.dragWatchers.hold,
                                    percentage: j / d.maxPosition * 100
                                }
                            };
                        } else {
                            if (d.minPosition > j) {
                                n = (j - d.minPosition) * d.resistance;
                                m = k - n;
                            }
                            e.simpleStates = {
                                opening: "right",
                                towards: e.dragWatchers.state,
                                hyperExtending: d.minPosition > j,
                                halfway: j < d.minPosition / 2,
                                flick: Math.abs(e.dragWatchers.current - e.dragWatchers.hold) > d.flickThreshold,
                                translation: {
                                    absolute: j,
                                    relative: k,
                                    sinceDirectionChange: e.dragWatchers.current - e.dragWatchers.hold,
                                    percentage: j / d.minPosition * 100
                                }
                            };
                        }
                        h.translate.x(m + i);
                ...
                endDrag: function(a) {
                    if (e.isDragging) {
                        g.dispatchEvent("end");
                        var b = h.translate.get.matrix(4);
                        if (e.dragWatchers.current === 0 && b !== 0 && d.tapToClose) {
                            g.dispatchEvent("close");
                            g.events.prevent(a);
                            h.translate.easeTo(0);
                            e.isDragging = false;
                            e.startDragX = 0;
                            return;
                        }
                            ...
                            if (e.simpleStates.halfway || e.simpleStates.hyperExtending || e.simpleStates.flick) {
                                if (e.simpleStates.flick && e.simpleStates.towards === "left") {
                                    ...
                                    if (e.simpleStates.flick && e.simpleStates.towards === "right" || (e.simpleStates.halfway || e.simpleStates.hyperExtending)) {
                                        h.translate.easeTo(d.maxPosition);
                                    }
                                }
                            } else {
                                h.translate.easeTo(0);
                                ...
                                if (e.simpleStates.halfway || e.simpleStates.hyperExtending || e.simpleStates.flick) {
                                    if (e.simpleStates.flick && e.simpleStates.towards === "right") {
                                        ...
                                        if (e.simpleStates.flick && e.simpleStates.towards === "left" || (e.simpleStates.halfway || e.simpleStates.hyperExtending)) {
                                            h.translate.easeTo(d.minPosition);
                                        }
                                    }
                                } else {
                                    h.translate.easeTo(0);
        ...
        this.open = function(a) {
            g.dispatchEvent("open");
            g.klass.remove(b.body, "snapjs-expand-left");
            g.klass.remove(b.body, "snapjs-expand-right");
            if (a === "left") {
        ...
        this.expand = function(c) {
            var d = a.innerWidth || b.documentElement.clientWidth;
            if (c === "left") {
                g.dispatchEvent("expandLeft");
                g.klass.add(b.body, "snapjs-expand-left");
                g.klass.remove(b.body, "snapjs-expand-right");
            } else {
                g.dispatchEvent("expandRight");
                g.klass.add(b.body, "snapjs-expand-right");
                g.klass.remove(b.body, "snapjs-expand-left");
                d *= -1;
            }
            h.translate.easeTo(d);
        };
        ...
        this.enable = function() {
            g.dispatchEvent("enable");
            h.drag.listen();
        };
        this.disable = function() {
            g.dispatchEvent("disable");
            h.drag.stopListening();
        };
        this.settings = function(a) {
            g.deepExtend(d, a);
        };
        this.state = function() {
            var a, b = h.translate.get.matrix(4);
            if (b === d.maxPosition) {
                a = "left";
            } else {
                if (b === d.minPosition) {
...
(function(a, b) {
    ...
    function l(a, b) {
        return typeof a == "string" ? a : a[b % a.length];
    }
    var m = {
        lines: 12,
        length: 7,
    ...
    j(n.prototype, {
        spin: function(a) {
            this.stop();
            var b = this, e = b.opts, f = b.el = i(d(0, {
            ...
            b.lines(f, b.opts);
            if (!c) {
                var h = 0, j = (e.lines - 1) * (1 - e.direction) / 2, k, l = e.fps, m = l / e.speed, n = (1 - e.opacity) / (m * e.trail / 100), o = m / e.lines;
                (function p() {
                    h++;
                    for (var a = 0; a < e.lines; a++) {
                        k = Math.max(1 - (h + (e.lines - a) * o) % m * n, e.opacity);
                        b.opacity(f, a * e.direction + j, k, e);
                    }
        ...
        lines: function(a, b) {
            ...
            for (;f < b.lines; f++) {
                ...
                if (b.shadow) e(j, i(k("#000", "0 0 4px " + "#000"), {
                    top: 2 + "px"
                }));
                e(a, e(j, k(l(b.color, f), "0 0 1px rgba(0,0,0,.1)")));
            }
            return a;
        },
    ...
    function o() {
        ...
        n.prototype.lines = function(b, c) {
            ...
            var h = -(c.width + c.length) * 2 + "px", j = i(g(), {
                position: "absolute",
                top: h,
                left: h
            }), k;
    ...
    if (!h(p, "transform") && p.adj) o(); else c = h(p, "animation");
    return n;
});
...
(function(a, b, c) {
    var d = {
        common: {
            init: function() {
                ...
                a(".snap-toggle").click(function(a) {
                ...
                c.register("screen and (max-width: 992px)", {
                    setup: function() {
    ...
    var e = {
        fire: function(a, b, c) {
            ...
            if (a !== "" && e[a] && typeof e[a][b] === "function") {
                e[a][b](c);
            }
        },
        loadEvents: function() {
